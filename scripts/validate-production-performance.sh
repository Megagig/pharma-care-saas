...
# Configuration
PRODUCTION_URL=${1:-"https://app.pharmacare.com"}
...
usage() {
    ...
    echo ""
    echo "Arguments:"
    echo "  production_url     URL to validate (default: https://app.pharmacare.com)"
    ...
    echo "Examples:"
    echo "  $0                                           # Use defaults"
    echo "  $0 https://staging.pharmacare.com           # Validate staging"
    echo "  $0 https://app.pharmacare.com baseline.md   # Custom baseline file"
}
