...
const mockPatient = Patient_1.default;
...
describe('usageLimitsMiddleware', () => {
    ...
    describe('checkPatientLimit', () => {
        ...
        it('should allow patient creation when under limit', async () => {
            mockPatient.countDocuments.mockResolvedValue(50);
        ...
        it('should block patient creation when over limit', async () => {
            mockPatient.countDocuments.mockResolvedValue(105);
            await middleware(mockRequest, mockResponse, mockNext);
            expect(mockResponse.status).toHaveBeenCalledWith(403);
            expect(mockResponse.json).toHaveBeenCalledWith({
                error: 'Patient limit exceeded',
        ...
        it('should handle unlimited plan', async () => {
            ...
            mockSubscriptionPlan.findById.mockResolvedValue(unlimitedPlan);
    ...
    describe('checkUserLimit', () => {
        ...
        it('should block user addition when at limit', async () => {
            ...
            mockWorkplace.findById.mockResolvedValue(workspaceAtLimit);
            await middleware(mockRequest, mockResponse, mockNext);
            expect(mockResponse.status).toHaveBeenCalledWith(403);
            expect(mockResponse.json).toHaveBeenCalledWith({
...
//# sourceMappingURL=usageLimits.test.js.map