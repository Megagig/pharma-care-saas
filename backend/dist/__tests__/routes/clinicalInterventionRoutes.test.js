...
describe('Clinical Intervention Routes', () => {
    ...
    beforeAll(async () => {
        ...
        authToken = jsonwebtoken_1.default.sign({ userId: testUser._id }, process.env.JWT_SECRET || 'test-secret');
    });
    afterAll(async () => {
...
//# sourceMappingURL=clinicalInterventionRoutes.test.js.map