...
export declare const getMTRSummaryReport: (req: AuthRequest, res: Response) => Promise<void>;
export declare const getInterventionEffectivenessReport: (req: AuthRequest, res: Response) => Promise<void>;
