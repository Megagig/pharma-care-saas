...
exports.diagnosticAnalyticsMiddleware =
  ...
  exports.requireDrugInteractionFeature =
  exports.requireLabIntegrationFeature =
  exports.requireAIDiagnosticsFeature =
  exports.requireDiagnosticAnalytics =
  exports.requireDiagnosticRetry =
  exports.requireDiagnosticCancel =
  exports.requireDiagnosticIntervention =
  ...
  exports.requireDiagnosticRead =
    void 0;
const auth_1 = require('../../../middlewares/auth');
const rbac_1 = require('../../../middlewares/rbac');
const auth_1 = require('../../../middlewares/auth');
const logger_1 = __importDefault(require('../../../utils/logger'));
exports.requireDiagnosticRead = (0, rbac_1.requirePermission)(
  'diagnostic:read'
);
exports.requireDiagnosticCreate = (0, rbac_1.requirePermission)(
  'diagnostic:create'
);
exports.requireDiagnosticProcess = (0, rbac_1.requirePermission)(
  'diagnostic:process'
);
exports.requireDiagnosticReview = (0, rbac_1.requirePermission)(
  'diagnostic:review'
);
exports.requireDiagnosticApprove = (0, rbac_1.requirePermission)(
  'diagnostic:approve'
);
exports.requireDiagnosticIntervention = (0, rbac_1.requirePermission)(
  'diagnostic:intervention'
);
exports.requireDiagnosticCancel = (0, rbac_1.requirePermission)(
  'diagnostic:cancel'
);
exports.requireDiagnosticRetry = (0, rbac_1.requirePermission)(
  'diagnostic:retry'
);
exports.requireDiagnosticAnalytics = (0, rbac_1.requirePermission)(
  'diagnostic:analytics'
);
exports.requireAIDiagnosticsFeature = (0, auth_1.requireFeature)(
  'ai_diagnostics'
);
exports.requireLabIntegrationFeature = (0, auth_1.requireFeature)(
  'lab_integration'
);
exports.requireDrugInteractionFeature = (0, auth_1.requireFeature)(
  'drug_interactions'
);
exports.requireDiagnosticAnalyticsFeature = (0, auth_1.requireFeature)(
...
const requirePharmacistRole = (req, res, next) => {
  ...
  const hasWorkplaceRole =
    ...
    allowedWorkplaceRoles.includes(req.user.workplaceRole);
    ...
    if (!req.workspaceContext.isSubscriptionActive) {
      if (
        ...
        const DiagnosticRequest =
          require('../models/DiagnosticRequest').default;
