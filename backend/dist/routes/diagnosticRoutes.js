...
router.post('/cases/:caseId/notes', diagnosticRateLimit, auth_1.auth, auth_1.requireLicense, (0, auditMiddleware_1.auditLogger)('SAVE_DIAGNOSTIC_NOTES', 'clinical_documentation'), diagnosticController_1.saveDiagnosticNotes);
...
router.get('/patients/:patientId/history', diagnosticRateLimit, auth_1.auth, (0, auth_1.requireFeature)('clinical_decision_support'), (0, auditMiddleware_1.auditLogger)('VIEW_PATIENT_DIAGNOSTIC_HISTORY', 'data_access'), diagnosticController_1.getPatientDiagnosticHistory);
