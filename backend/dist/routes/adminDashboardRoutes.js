...
router.get('/overview', adminDashboardController_1.adminDashboardController.getDashboardOverview.bind(adminDashboardController_1.adminDashboardController));
router.get('/workspaces', adminDashboardController_1.adminDashboardController.getWorkspaceManagement.bind(adminDashboardController_1.adminDashboardController));
...
router.get('/system-health', adminDashboardController_1.adminDashboardController.getSystemHealth.bind(adminDashboardController_1.adminDashboardController));
