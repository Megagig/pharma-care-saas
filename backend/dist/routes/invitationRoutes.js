...
router.post('/workspaces/:id/invitations', rateLimiting_1.invitationRateLimiters.createInvitation, authWithWorkspace_1.authWithWorkspace, rateLimiting_1.invitationRateLimiters.createInvitationUser, rateLimiting_1.abuseDetection.invitationSpam, (0, rbac_1.requirePermission)('invitation.create'), invitationController_1.createInvitation);
...
router.post('/invitations/accept', invitationController_1.acceptInvitationPublic);
