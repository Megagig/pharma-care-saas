...
router.post('/users/assign-roles', userRoleController_1.userRoleController.assignUserRoles);
router.delete('/users/:id/roles/:roleId', userRoleController_1.userRoleController.revokeUserRole);
router.put('/users/:id/permissions', userRoleController_1.userRoleController.updateUserPermissions);
router.get('/users/:id/effective-permissions', userRoleController_1.userRoleController.getUserEffectivePermissions);
router.post('/users/bulk-update', userRoleController_1.userRoleController.bulkUpdateUsers);
...
router.post('/users/:id/detect-conflicts', userRoleController_1.userRoleController.detectRoleConflicts);
router.post('/users/:id/resolve-conflicts', userRoleController_1.userRoleController.resolveRoleConflicts);
