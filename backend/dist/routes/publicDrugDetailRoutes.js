...
router.get('/interactions', async (req, res) => {
    try {
        ...
        console.log(`Public drug interactions request received for RxCUI: ${rxcui}`);
        return res.json({
            success: true,
            data: {
                                ...
                                interactionPair: [
                                    {
                                        ...
                                        severity: 'Moderate',
                                        description: 'This is a sample drug interaction description.',
                                    },
                                ],
                            },
                        ],
...
router.get('/adverse-effects/:id', async (req, res) => {
    try {
        ...
        console.log(`Public adverse effects request received for ID: ${id}, limit: ${limitNum}`);
        return res.json({
            success: true,
            data: {
                meta: {
        ...
        logger_1.default.error('Public adverse effects error:', error);
        res.status(500).json({
            success: false,
...
router.get('/formulary/:id', async (req, res) => {
    try {
        ...
        logger_1.default.error('Public formulary error:', error);
        res.status(500).json({
            success: false,
...
//# sourceMappingURL=publicDrugDetailRoutes.js.map