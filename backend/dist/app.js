...
const pharmacistLabInterpretation_routes_1 = __importDefault(require("./routes/pharmacistLabInterpretation.routes"));
const pharmacistVitals_routes_1 = __importDefault(require("./routes/pharmacistVitals.routes"));
const pharmacistVisitSummary_routes_1 = __importDefault(require("./routes/pharmacistVisitSummary.routes"));
const workplaceHealthRecords_routes_1 = __importDefault(require("./routes/workplaceHealthRecords.routes"));
const patientNotification_routes_1 = __importDefault(require("./routes/patientNotification.routes"));
const appointmentHealthRecords_routes_1 = __importDefault(require("./routes/appointmentHealthRecords.routes"));
const superAdminHealthRecords_routes_1 = __importDefault(require("./routes/superAdminHealthRecords.routes"));
...
app.use('/api/super-admin/health-records', superAdminHealthRecords_routes_1.default);
...
app.use('/api/pharmacist/lab-results', pharmacistLabInterpretation_routes_1.default);
app.use('/api/pharmacist/vitals', pharmacistVitals_routes_1.default);
app.use('/api/pharmacist/visit-summaries', pharmacistVisitSummary_routes_1.default);
app.use('/api/workplace/health-records-features', workplaceHealthRecords_routes_1.default);
app.use('/api/patient-portal/notifications', patientNotification_routes_1.default);
app.use('/api/appointments', appointmentHealthRecords_routes_1.default);
