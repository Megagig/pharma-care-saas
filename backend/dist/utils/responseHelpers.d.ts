...
export type ErrorCode = 'VALIDATION_ERROR' | 'NOT_FOUND' | 'UNAUTHORIZED' | 'FORBIDDEN' | 'CONFLICT' | 'DUPLICATE_RESOURCE' | 'PLAN_LIMIT_EXCEEDED' | 'TENANT_VIOLATION' | 'BUSINESS_RULE_VIOLATION' | 'SERVER_ERROR' | 'BAD_REQUEST' | 'SERVICE_UNAVAILABLE' | 'USER_FETCH_ERROR' | 'INVALID_USER_ID' | 'USER_NOT_FOUND' | 'USER_DETAIL_ERROR' | 'INVALID_ROLE_ID' | 'ROLE_NOT_FOUND' | 'ROLE_ALREADY_ASSIGNED' | 'ROLE_UPDATE_ERROR' | 'REASON_REQUIRED' | 'USER_ALREADY_SUSPENDED' | 'SUSPEND_ERROR' | 'USER_NOT_SUSPENDED' | 'REACTIVATE_ERROR' | 'INVALID_USER_IDS' | 'BULK_ASSIGN_ERROR' | 'IMPERSONATION_FORBIDDEN' | 'IMPERSONATION_ERROR' | 'STATISTICS_ERROR' | 'SEARCH_ERROR' | 'USER_NOT_PENDING' | 'APPROVE_ERROR' | 'REJECT_ERROR' | 'BULK_APPROVE_ERROR' | 'BULK_REJECT_ERROR' | 'BULK_SUSPEND_ERROR' | 'MISSING_FIELDS' | 'USER_EXISTS' | 'CREATE_ERROR' | 'SUBSCRIPTION_ANALYTICS_ERROR' | 'PHARMACY_USAGE_ERROR' | 'CLINICAL_OUTCOMES_ERROR' | 'INVALID_FORMAT' | 'EXPORT_ERROR' | 'SCHEDULE_ERROR' | 'AUDIT_LOGS_ERROR' | 'AUDIT_SUMMARY_ERROR' | 'COMPLIANCE_REPORT_ERROR' | 'AUDIT_LOG_NOT_FOUND' | 'AUDIT_REVIEW_ERROR' | 'FLAGGED_LOGS_ERROR' | 'FEATURE_FLAGS_ERROR' | 'INVALID_FLAG_ID' | 'FLAG_NOT_FOUND' | 'INVALID_TARGETING_RULES' | 'TARGETING_UPDATE_ERROR' | 'USAGE_METRICS_ERROR' | 'FLAG_TOGGLE_ERROR' | 'NOTIFICATION_SETTINGS_ERROR' | 'NOTIFICATION_SETTINGS_UPDATE_ERROR' | 'NOTIFICATION_RULES_ERROR' | 'NOTIFICATION_SEND_ERROR' | 'NOTIFICATION_TEMPLATES_ERROR' | 'NOTIFICATION_HISTORY_ERROR' | 'NOTIFICATION_TEST_ERROR' | 'NOTIFICATION_STATS_ERROR' | 'OVERVIEW_ERROR' | 'RECENT_ACTIVITY_ERROR' | 'SYSTEM_HEALTH_ERROR' | 'SECURITY_SETTINGS_ERROR' | 'SECURITY_SETTINGS_UPDATE_ERROR' | 'ACTIVE_SESSIONS_ERROR' | 'SESSION_TERMINATION_ERROR' | 'SECURITY_LOGS_ERROR' | 'SECURITY_ALERTS_ERROR' | 'MFA_ENFORCEMENT_ERROR' | 'PASSWORD_POLICY_ERROR' | 'PASSWORD_POLICY_UPDATE_ERROR' | 'ACCOUNT_LOCKOUT_UPDATE_ERROR' | 'IMPACT_ANALYSIS_ERROR' | 'INVALID_FLAG_IDS' | 'INVALID_UPDATES' | 'BULK_UPDATE_ERROR' | 'ROLLOUT_STATUS_ERROR' | 'CHANNELS_ERROR' | 'CHANNEL_UPDATE_ERROR' | 'RULES_ERROR' | 'RULE_CREATE_ERROR' | 'RULE_NOT_FOUND' | 'RULE_UPDATE_ERROR' | 'RULE_DELETE_ERROR' | 'RULE_TOGGLE_ERROR' | 'TEMPLATES_ERROR' | 'TEMPLATE_CREATE_ERROR' | 'TEMPLATE_NOT_FOUND' | 'TEMPLATE_UPDATE_ERROR' | 'TEMPLATE_DELETE_ERROR' | 'HISTORY_ERROR' | 'TEST_NOTIFICATION_ERROR' | 'METRICS_ERROR' | 'HEALTH_CHECK_ERROR' | 'ACTIVITIES_ERROR' | 'PERFORMANCE_ERROR' | 'REFRESH_ERROR' | 'INVALID_PASSWORD_POLICY' | 'PASSWORD_POLICY_UPDATE_ERROR' | 'SESSIONS_ERROR' | 'INVALID_SESSION_ID' | 'SESSION_NOT_FOUND' | 'USER_ALREADY_LOCKED' | 'ACCOUNT_LOCK_ERROR' | 'USER_NOT_LOCKED' | 'ACCOUNT_UNLOCK_ERROR' | 'SECURITY_DASHBOARD_ERROR' | 'TICKET_CREATION_ERROR' | 'TICKETS_FETCH_ERROR' | 'TICKET_NOT_FOUND' | 'TICKET_FETCH_ERROR' | 'TICKET_ASSIGNMENT_ERROR' | 'TICKET_UPDATE_ERROR' | 'TICKET_ESCALATION_ERROR' | 'COMMENT_CREATION_ERROR' | 'COMMENTS_FETCH_ERROR' | 'ARTICLE_CREATION_ERROR' | 'ARTICLES_FETCH_ERROR' | 'ANALYTICS_ERROR' | 'HELP_CONTENT_ERROR' | 'CATEGORIES_ERROR' | 'FEEDBACK_ERROR' | 'SETTINGS_ERROR' | 'SETTINGS_UPDATE_ERROR' | 'PDF_GENERATION_ERROR' | 'FAQ_CREATION_ERROR' | 'FAQ_NOT_FOUND' | 'FAQ_UPDATE_ERROR' | 'FAQ_DELETE_ERROR' | 'VIDEO_CREATION_ERROR' | 'VIDEO_NOT_FOUND' | 'VIDEO_UPDATE_ERROR' | 'VIDEO_DELETE_ERROR' | 'FEEDBACK_FETCH_ERROR' | 'FEEDBACK_NOT_FOUND' | 'FEEDBACK_RESPONSE_ERROR' | 'ARTICLE_NOT_FOUND' | 'ARTICLE_FETCH_ERROR' | 'ARTICLE_UPDATE_ERROR' | 'ARTICLE_DELETE_ERROR';
