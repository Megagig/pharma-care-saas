...
export class PerformanceAlertService {
      ...
      channels: [
        {
          ...
          config: {
            ...
            from: process.env.ALERT_FROM_EMAIL || 'alerts@PharmaPilot.com',
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
          <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; font-size: 12px; color: #666;">
              This alert was generated by the PharmaPilot Performance Monitoring System.
            </div>
          </div>
        </body>
      </html>
  ...
  static async sendAlert(alertData: {
    ...
    const alert: PerformanceAlert = {
      ...
      url: alertData.data?.url || 'https://app.PharmaPilot.com',
      timestamp: new Date(),
