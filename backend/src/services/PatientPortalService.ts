...
class PatientPortalService {
  ...
  static async bookAppointment(
    ...
    try {
      // Validate that the patient exists and belongs to the workplace
      ...
      if (!patient) {
        throw new ValidationError('Patient not found or does not belong to this workplace');
      }
      ...
      const appointmentData: CreateAppointmentData = {
        ...
        assignedTo: bookingData.assignedTo,
        title: `${bookingData.type.replace('_', ' ')} - ${patient.firstName} ${patient.lastName}`,
      ...
      await this.sendBookingConfirmation(appointment, patient, confirmationNumber);
