 ...
 */
export const requireInterventionCreate = requirePermission(
 ...
 */
export const requireInterventionRead = requirePermission(
 ...
 */
export const requireInterventionUpdate = requirePermission(
 ...
 */
export const requireInterventionDelete = requirePermission(
 ...
 */
export const requireInterventionAssign = requirePermission(
 ...
 */
export const requireInterventionReports = requirePermission(
 ...
 */
export const requireInterventionExport = requirePermission(
   ...
   try {
      ...
      if (interventionWorkplaceId !== userWorkplaceId) {
         res.status(403).json({
            success: false,
            message:
               'Access denied. Intervention belongs to different workplace.',
         });
         return;
      }
...
export const checkInterventionModifyAccess = async (
   ...
   try {
      ...
      const isCreator =
         intervention.identifiedBy.toString() === req.user._id.toString();
      if (!isCreator) {
         res.status(403).json({
            success: false,
            message:
               'Access denied. You can only modify interventions you created.',
         });
         return;
      }
...
export const checkInterventionAssignAccess = async (
   ...
   try {
      ...
      const hasTeamManagement =
         req.workspaceContext.permissions.includes('teamManagement');
...
export const checkInterventionReportAccess = async (
   ...
   try {
      ...
      const hasAdvancedReports =
         req.workspaceContext.permissions.includes('advancedReports');
