 ...
 */
export const canExportClinicalNotes = requirePermission('clinical_notes.export');
...
export const validateNoteAccess = async (
    ...
    try {
        ...
        if (!note) {
            ...
            await auditOperations.unauthorizedAccess(req, 'clinical_note', noteId, 'Note not found or access denied');
