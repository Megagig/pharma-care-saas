...
const mockSubscriptionPlan = SubscriptionPlan as jest.Mocked<
...
describe('InvitationService', () => {
   ...
   describe('acceptInvitation', () => {
      ...
      it('should accept invitation successfully', async () => {
         ...
         mockWorkplace.findByIdAndUpdate.mockResolvedValue(
            mockWorkspaceData as any
         );

         const result =
            await invitationService.acceptInvitation(acceptanceData);
