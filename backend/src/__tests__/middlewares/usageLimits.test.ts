...
describe('usageLimitsMiddleware', () => {
   ...
   describe('checkPatientLimit', () => {
      ...
      it('should handle unlimited plan', async () => {
         const unlimitedPlan = {
            ...mockPlanData,
            limits: { ...mockPlanData.limits, patients: -1 },
         };
   ...
   describe('checkUserLimit', () => {
      ...
      it('should handle unlimited users', async () => {
         const unlimitedPlan = {
            ...mockPlanData,
            limits: { ...mockPlanData.limits, users: -1 },
         };
         mockSubscriptionPlan.findById.mockResolvedValue(unlimitedPlan as any);
         ...
         mockWorkplace.findById.mockResolvedValue(
            workspaceWithManyUsers as any
         );
   ...
   describe('checkStorageLimit', () => {
      ...
      it('should allow file upload when under storage limit', async () => {
         ...
         jest
            .spyOn(usageLimitsMiddleware, 'getCurrentStorageUsage')
      ...
      it('should handle unlimited storage', async () => {
         const unlimitedPlan = {
            ...mockPlanData,
            limits: { ...mockPlanData.limits, storage: -1 },
         };
         mockSubscriptionPlan.findById.mockResolvedValue(unlimitedPlan as any);
         jest
            .spyOn(usageLimitsMiddleware, 'getCurrentStorageUsage')
   ...
   describe('checkApiCallLimit', () => {
      ...
      it('should allow API call when under limit', async () => {
         ...
         jest
            .spyOn(usageLimitsMiddleware, 'getCurrentApiCallCount')
      ...
      it('should handle unlimited API calls', async () => {
         const unlimitedPlan = {
            ...mockPlanData,
            limits: { ...mockPlanData.limits, apiCalls: -1 },
         };
         mockSubscriptionPlan.findById.mockResolvedValue(unlimitedPlan as any);
         jest
            .spyOn(usageLimitsMiddleware, 'getCurrentApiCallCount')
   ...
   describe('getUsageStats', () => {
      it('should return current usage statistics', async () => {
         ...
         const stats = await usageLimitsMiddleware.getUsageStats(
