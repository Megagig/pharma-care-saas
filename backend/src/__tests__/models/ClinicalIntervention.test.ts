   ...
   describe('Schema Validation', () => {
      ...
      it('should validate intervention number format', async () => {
         const interventionData = {
            ...
            priority: 'high' as const,
            issueDescription:
               'Test issue description that meets minimum length requirement',
            identifiedBy: testUserId,
            createdBy: testUserId,
         };
      ...
      it('should validate category enum values', async () => {
         const interventionData = {
            ...
            priority: 'high' as const,
            issueDescription:
               'Valid issue description that meets minimum length requirement',
            identifiedBy: testUserId,
            createdBy: testUserId,
         };
   ...
   describe('Strategy Management', () => {
      ...
      it('should add strategy and update status', async () => {
         const strategy = {
            ...
            expectedOutcome:
               'Reduction in side effects while maintaining therapeutic effect',
         ...
         await ClinicalIntervention.create([
            {
               ...
               priority: 'high' as const,
               issueDescription:
                  'Test issue 1 that meets minimum length requirement',
               identifiedBy: testUserId,
               createdBy: testUserId,
               status: 'in_progress',
            },
            {
               ...
               issueDescription:
                  'Test issue 2 that meets minimum length requirement',
               identifiedBy: testUserId,
               createdBy: testUserId,
               status: 'completed',
            ...
            },
            {
               ...
               issueDescription:
                  'Test issue 3 that meets minimum length requirement',
               identifiedBy: testUserId,
               createdBy: testUserId,
               status: 'planning',
   ...
   describe('Pre-save Middleware', () => {
      it('should auto-generate intervention number', async () => {
         const intervention = new ClinicalIntervention({
            ...
            priority: 'high' as const,
            issueDescription:
               'Test issue that meets minimum length requirement',
            identifiedBy: testUserId,
            createdBy: testUserId,
         });
      ...
      it('should require strategies for non-identified status', async () => {
         ...
         await expect(intervention.save()).rejects.toThrow(
            /At least one intervention strategy is required/
         );
      });
      ...
      it('should require outcome for implemented status', async () => {
         ...
         await expect(intervention.save()).rejects.toThrow(
            /Patient response outcome is required/
         );
      });
