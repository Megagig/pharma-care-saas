...
describe('ClinicalInterventionController - Comprehensive Tests', () => {
   ...
   describe('GET /api/clinical-interventions', () => {
      ...
      it('should get interventions with default pagination', async () => {
         app.get(
            '/api/clinical-interventions',
            clinicalInterventionController.getClinicalInterventions
         );
   ...
   describe('POST /api/clinical-interventions', () => {
      const validInterventionData = {
         ...
         priority: 'high',
         issueDescription:
            'Patient experiencing side effects from current medication regimen',
         strategies: [
            {
      ...
      it('should create intervention with valid data', async () => {
         app.post(
            '/api/clinical-interventions',
            clinicalInterventionController.createClinicalIntervention
         );
      ...
      it('should handle related MTR and DTP IDs', async () => {
         ...
         const dataWithRelations = {
            ...
            relatedDTPIds: [
               testUtils.createObjectId().toString(),
               testUtils.createObjectId().toString(),
            ],
         };
      ...
      it('should log intervention access', async () => {
         ...
         const ClinicalInterventionService =
            require('../../services/clinicalInterventionService').default;
         expect(
            ClinicalInterventionService.logInterventionAccess
         ).toHaveBeenCalledWith(
            expect.any(String),
            pharmacistId,
            workplaceId,
   ...
   describe('GET /api/clinical-interventions/:id', () => {
      ...
      it('should get intervention by ID', async () => {
         app.get(
            '/api/clinical-interventions/:id',
            clinicalInterventionController.getClinicalIntervention
         );
         ...
         const ClinicalInterventionService =
            require('../../services/clinicalInterventionService').default;
         expect(
            ClinicalInterventionService.getInterventionById
         ).toHaveBeenCalledWith(interventionId, workplaceId);
      });
   ...
   describe('PATCH /api/clinical-interventions/:id', () => {
      ...
      it('should update intervention with valid data', async () => {
         app.patch(
            '/api/clinical-interventions/:id',
            clinicalInterventionController.updateClinicalIntervention
         );

         const updates = {
            priority: 'critical',
            issueDescription:
               'Updated issue description with more detailed information',
         ...
         const ClinicalInterventionService =
            require('../../services/clinicalInterventionService').default;
         expect(
            ClinicalInterventionService.updateIntervention
         ).toHaveBeenCalledWith(
            interventionId,
            updates,
            pharmacistId,
   ...
   describe('DELETE /api/clinical-interventions/:id', () => {
      ...
      it('should delete intervention', async () => {
         app.delete(
            '/api/clinical-interventions/:id',
            clinicalInterventionController.deleteClinicalIntervention
         );
         ...
         const ClinicalInterventionService =
            require('../../services/clinicalInterventionService').default;
         expect(
            ClinicalInterventionService.deleteIntervention
         ).toHaveBeenCalledWith(interventionId, pharmacistId, workplaceId);
      });
      ...
      it('should handle deletion failure', async () => {
         const ClinicalInterventionService =
            require('../../services/clinicalInterventionService').default;
         ClinicalInterventionService.deleteIntervention.mockResolvedValue(
            false
         );
   ...
   describe('POST /api/clinical-interventions/:id/strategies', () => {
      ...
      it('should add strategy to intervention', async () => {
         app.post(
            '/api/clinical-interventions/:id/strategies',
            clinicalInterventionController.addInterventionStrategy
         );
   ...
   describe('POST /api/clinical-interventions/:id/assignments', () => {
      ...
      it('should assign team member to intervention', async () => {
         app.post(
            '/api/clinical-interventions/:id/assignments',
            clinicalInterventionController.assignTeamMember
         );
   ...
   describe('POST /api/clinical-interventions/:id/outcomes', () => {
      ...
      it('should record intervention outcome', async () => {
         app.post(
            '/api/clinical-interventions/:id/outcomes',
            clinicalInterventionController.recordOutcome
         );
   ...
   describe('POST /api/clinical-interventions/:id/follow-up', () => {
      ...
      it('should schedule follow-up', async () => {
         app.post(
            '/api/clinical-interventions/:id/follow-up',
            clinicalInterventionController.scheduleFollowUp
         );
         ...
         const ClinicalInterventionService =
            require('../../services/clinicalInterventionService').default;
         expect(
            ClinicalInterventionService.scheduleFollowUp
         ).toHaveBeenCalledWith(
            interventionId,
            expect.objectContaining({
               required: true,
   ...
   describe('GET /api/clinical-interventions/patient/:patientId', () => {
      ...
      it('should get patient interventions with summary', async () => {
         app.get(
            '/api/clinical-interventions/patient/:patientId',
            clinicalInterventionController.getPatientInterventions
         );
         ...
         expect(
            ClinicalInterventionService.getPatientInterventionSummary
         ).toHaveBeenCalledWith(patientId, workplaceId);
      });
   ...
   describe('GET /api/clinical-interventions/assigned-to-me', () => {
      ...
      it('should get user assigned interventions', async () => {
         app.get(
            '/api/clinical-interventions/assigned-to-me',
            clinicalInterventionController.getAssignedInterventions
         );
         ...
         ).toHaveBeenCalledWith(pharmacistId, workplaceId, undefined);
         expect(
            ClinicalInterventionService.getUserAssignmentStats
         ).toHaveBeenCalledWith(pharmacistId, workplaceId);
      });
      ...
      it('should handle status filter', async () => {
         ...
         expect(
            ClinicalInterventionService.getUserAssignments
         ).toHaveBeenCalledWith(pharmacistId, workplaceId, ['pending']);
      });
   });
   ...
   describe('GET /api/clinical-interventions/analytics/summary', () => {
      ...
      it('should get analytics with default date range', async () => {
         app.get(
            '/api/clinical-interventions/analytics/summary',
            clinicalInterventionController.getInterventionAnalytics
         );
   ...
   describe('Error Handling', () => {
      it('should handle service errors gracefully', async () => {
         const ClinicalInterventionService =
            require('../../services/clinicalInterventionService').default;
         ClinicalInterventionService.getInterventions.mockRejectedValue(
         ...
         await request(app).get('/api/clinical-interventions').expect(500);
      });
      ...
      it('should handle not found errors', async () => {
         ...
         ClinicalInterventionService.getInterventionById.mockRejectedValue(
            notFoundError
         );
