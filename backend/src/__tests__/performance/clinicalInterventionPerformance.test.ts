...
describe('Clinical Intervention Performance Tests', () => {
   ...
   describe('Index Utilization', () => {
      ...
      it('should use index for intervention number queries', async () => {
         ...
         console.log(
            `Intervention number index query completed in ${executionTime}ms`
         );
      });
   });
   ...
   describe('Memory Usage', () => {
      ...
      it('should handle streaming large datasets efficiently', async () => {
         ...
         console.log(
            `Streamed ${processedCount} documents in ${executionTime}ms with ${Math.round(memoryIncrease / 1024 / 1024)}MB memory increase`
         );
      });
   });
   ...
   describe('Bulk Operations Performance', () => {
      it('should handle bulk inserts efficiently', async () => {
         ...
         const count = await ClinicalIntervention.countDocuments().setOptions({
            workplaceId: testWorkplaceId,
         });
      ...
      it('should handle bulk deletes efficiently', async () => {
         ...
         console.log(
            `Bulk soft deleted 300 interventions in ${executionTime}ms`
         );
      });
   });
   ...
   describe('Stress Testing', () => {
      ...
      it('should maintain performance under memory pressure', async () => {
               ...
               strategies: [
                  {
                     ...
                     description:
                        'Detailed strategy description with lots of text',
                     rationale:
                        'Comprehensive rationale explaining the clinical reasoning behind this intervention strategy',
                     expectedOutcome:
                        'Expected outcome with detailed explanation of what we hope to achieve with this intervention',
                     priority: 'primary',
                  },
               ],
               implementationNotes:
                  'Detailed implementation notes with comprehensive information about how this intervention should be carried out',
            });
         }
         ...
         console.log(
            `Query under memory pressure completed in ${executionTime}ms`
         );
      });
   });
});
