...
const developmentConfig: EnvironmentConfig = {
   ...
   database: {
      uri:
         process.env.MONGODB_URI || 'mongodb://localhost:27017/pharmatech_dev',
      options: {
         maxPoolSize: 5,
         minPoolSize: 1,
         maxIdleTimeMS: 30000,
...
const stagingConfig: EnvironmentConfig = {
   ...
   database: {
      uri:
         ...
         'mongodb://localhost:27017/pharmatech_staging',
      options: {
         maxPoolSize: 10,
         minPoolSize: 2,
         maxIdleTimeMS: 30000,
...
const testConfig: EnvironmentConfig = {
   ...
   database: {
      uri:
         ...
         'mongodb://localhost:27017/pharmatech_test',
      options: {
         maxPoolSize: 5,
         minPoolSize: 1,
         maxIdleTimeMS: 10000,
