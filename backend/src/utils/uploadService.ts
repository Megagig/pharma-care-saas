...
export const validateFileExists =
   FileUploadService.fileExists.bind(FileUploadService);
...
export const getFilePath =
   FileUploadService.getFilePath.bind(FileUploadService);
export const getFileStats =
   FileUploadService.getFileStats.bind(FileUploadService);
