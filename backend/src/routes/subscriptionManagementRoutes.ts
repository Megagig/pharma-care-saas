...
router.get(
   ...
   authWithWorkspace,
   subscriptionManagementController.getWorkspaceSubscription.bind(
...
router.post(
   ...
   subscriptionManagementController.createTrialSubscription.bind(
      subscriptionManagementController
   )
);
...
router.patch(
   ...
   subscriptionManagementController.updateSubscriptionStatus.bind(
      subscriptionManagementController
   )
);
...
router.post(
   ...
   authWithWorkspace,
   requirePermission('subscription.manage'),
   subscriptionManagementController.createWorkspaceCheckout.bind(
      subscriptionManagementController
   )
);
...
router.post(
   ...
   authWithWorkspace,
   subscriptionManagementController.handleWorkspacePaymentSuccess.bind(
      subscriptionManagementController
   )
);
...
router.post(
   ...
   authWithWorkspace,
   requirePermission('subscription.manage'),
   subscriptionManagementController.upgradeWorkspaceSubscription.bind(
      subscriptionManagementController
   )
);
...
router.post(
   ...
   authWithWorkspace,
   requirePermission('subscription.manage'),
   subscriptionManagementController.downgradeWorkspaceSubscription.bind(
      subscriptionManagementController
   )
);
...
router.delete(
   ...
   authWithWorkspace,
   requirePermission('subscription.manage'),
   subscriptionManagementController.cancelScheduledDowngrade.bind(
      subscriptionManagementController
   )
);
...
router.post(
   ...
   subscriptionRateLimiters.paymentAttempt,
   authWithWorkspace,
   subscriptionManagementController.handleUpgradePaymentSuccess.bind(
      subscriptionManagementController
   )
);
...
router.get(
   ...
   authWithWorkspace,
   subscriptionManagementController.checkTrialExpiry.bind(
      subscriptionManagementController
   )
);
...
router.post(
   ...
   authWithWorkspace,
   requirePermission('subscription.admin'),
   subscriptionManagementController.extendTrialPeriod.bind(
      subscriptionManagementController
   )
);
...
router.post(
   ...
   authWithWorkspace,
   requirePermission('subscription.admin'),
   subscriptionManagementController.handleSubscriptionExpiry.bind(
      subscriptionManagementController
   )
);
...
router.post(
   ...
   authWithWorkspace,
   subscriptionManagementController.enablePaywallMode.bind(
      subscriptionManagementController
   )
);
...
router.get(
   '/workspace/:workspaceId/status',
   authWithWorkspace,
   subscriptionManagementController.getSubscriptionStatus.bind(
      subscriptionManagementController
   )
);
