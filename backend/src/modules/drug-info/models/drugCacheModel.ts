...
export const DrugSearchHistory = mongoose.model<DrugSearchHistoryDocument>(
   'DrugSearchHistory',
   drugSearchHistorySchema
);
export const TherapyPlan = mongoose.model<TherapyPlanDocument>(
   'TherapyPlan',
   therapyPlanSchema
);
