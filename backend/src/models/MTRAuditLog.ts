...
mtrAuditLogSchema.virtual('riskLevelDisplay').get(function (this: IMTRAuditLog) {
    const riskMap = {
        low: 'Low Risk',
        medium: 'Medium Risk',
        high: 'High Risk',
...
mtrAuditLogSchema.virtual('complianceCategoryDisplay').get(function (this: IMTRAuditLog) {
    const categoryMap = {
...
export default mongoose.model<IMTRAuditLog, IMTRAuditLogModel>('MTRAuditLog', mtrAuditLogSchema);