...
const drugTherapyProblemSchema = new Schema(
   {
      ...
      clinicalSignificance: {
         ...
         maxlength: [
            1000,
            'Clinical significance cannot exceed 1000 characters',
         ],
      },
      affectedMedications: [
         {
      ...
      resolution: {
         action: {
            ...
            maxlength: [
               1000,
               'Resolution action cannot exceed 1000 characters',
            ],
         },
         outcome: {
            type: String,
            ...
            maxlength: [
               1000,
               'Resolution outcome cannot exceed 1000 characters',
            ],
         },
         resolvedAt: Date,
         resolvedBy: {
...
drugTherapyProblemSchema.index(
...
drugTherapyProblemSchema.virtual('resolutionDurationDays').get(function (
...
drugTherapyProblemSchema.virtual('priority').get(function (
   this: IDrugTherapyProblem
) {
...
drugTherapyProblemSchema.virtual('typeDisplay').get(function (
   this: IDrugTherapyProblem
) {
...
drugTherapyProblemSchema.pre('save', function (this: IDrugTherapyProblem) {
   ...
   if (
      ...
      (!this.clinicalSignificance ||
         this.clinicalSignificance.trim().length < 10)
   ) {
      throw new Error(
