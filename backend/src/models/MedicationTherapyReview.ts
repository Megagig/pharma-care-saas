      ...
      medications: [
         {
            ...
            prescriber: {
               name: {
                  ...
                  maxlength: [
                     100,
                     'Prescriber name cannot exceed 100 characters',
                  ],
               },
               license: {
                  type: String,
         ...
         recommendations: [
            {
               ...
               medication: {
                  ...
                  maxlength: [
                     200,
                     'Medication name cannot exceed 200 characters',
                  ],
               },
               rationale: {
                  type: String,
         ...
         counselingPoints: [
            {
               ...
               maxlength: [
                  500,
                  'Counseling point cannot exceed 500 characters',
               ],
            },
         ],
         goals: [
            {
               description: {
                  ...
                  maxlength: [
                     300,
                     'Goal description cannot exceed 300 characters',
                  ],
               },
               targetDate: Date,
               achieved: {
