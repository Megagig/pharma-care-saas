...
export class MTRHelper {
   ...
   async navigateToMTR() {
      ...
      await expect(
         this.page.locator('[data-testid="mtr-dashboard"]')
      ).toBeVisible();
   ...
   async startNewMTRSession(patientData: MTRTestData['patient']) {
      ...
      await expect(
         this.page.locator('[data-testid="patient-selection-step"]')
      ).toBeVisible();
      ...
      await this.page.click(
         `[data-testid="patient-result-${patientData.mrn}"]`
      );
      ...
      await expect(
         this.page.locator('[data-testid="medication-history-step"]')
      ).toBeVisible();
   ...
   async addMedications(medications: MTRTestData['medications']) {
      ...
      for (const medication of medications) {
         ...
         await expect(
            this.page.locator(
               `[data-testid="medication-item-${medication.drugName}"]`
            )
         ).toBeVisible();
      }
      ...
      await expect(
         this.page.locator('[data-testid="therapy-assessment-step"]')
      ).toBeVisible();
   ...
   async performTherapyAssessment(problems: MTRTestData['problems']) {
      ...
      for (const problem of problems) {
         ...
         await expect(
            this.page.locator(`[data-testid="problem-item"]`)
         ).toBeVisible();
      }
      ...
      await expect(
         this.page.locator('[data-testid="plan-development-step"]')
      ).toBeVisible();
   ...
   async developTherapyPlan() {
      ...
      const problems = await this.page
         .locator('[data-testid="identified-problem"]')
         .all();
      ...
      await this.page.fill(
         '[data-testid="monitoring-parameter-input"]',
      ...
      await expect(
         this.page.locator('[data-testid="interventions-step"]')
      ).toBeVisible();
   ...
   async recordInterventions(interventions: MTRTestData['interventions']) {
      ...
      for (const intervention of interventions) {
         ...
         await expect(
            this.page.locator('[data-testid="intervention-item"]')
         ).toBeVisible();
      }
      ...
      await expect(
         this.page.locator('[data-testid="follow-up-step"]')
      ).toBeVisible();
   ...
   async scheduleFollowUp() {
      ...
      await this.page.fill(
         ...
         'Follow up on therapy changes and patient response'
      );
      ...
      await expect(
         this.page.locator('[data-testid="scheduled-followup"]')
      ).toBeVisible();
   ...
   async completeMTRSession() {
      ...
      await expect(
         this.page.locator('[data-testid="mtr-completed-message"]')
      ).toBeVisible();
   ...
   async verifyMTRInHistory(patientMRN: string) {
      ...
      await expect(
         this.page.locator(`[data-testid="mtr-history-item-${patientMRN}"]`)
      ).toBeVisible();
   ...
   async testStepNavigation() {
      ...
      for (let i = 0; i < steps.length - 1; i++) {
         await this.page.click('[data-testid="next-step-button"]');
         await expect(
            this.page.locator(`[data-testid="${steps[i + 1]}"]`)
         ).toBeVisible();
      }
   ...
   async testDataPersistence() {
      ...
      await expect(
         this.page.locator('[data-testid="medication-item-Test Medication"]')
      ).toBeVisible();
