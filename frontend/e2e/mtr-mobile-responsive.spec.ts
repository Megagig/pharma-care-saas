...
test.describe('MTR Mobile and Responsive E2E Tests', () => {
   ...
   test.describe('Mobile Device Tests', () => {
      ...
      test('should complete MTR workflow on mobile device', async ({
         page,
      }) => {
         ...
         await expect(
            page.locator('[data-testid="mobile-mtr-layout"]')
         ).toBeVisible();

         // Test mobile navigation
         await page.click('[data-testid="mobile-menu-button"]');
         await expect(
            page.locator('[data-testid="mobile-navigation-drawer"]')
         ).toBeVisible();
         ...
         await expect(
            page.locator('[data-testid="mobile-medication-form"]')
         ).toBeVisible();
         ...
         await expect(
            page.locator('[data-testid="mobile-dropdown-options"]')
         ).toBeVisible();
         ...
         await expect(
            page.locator('[data-testid="medication-item-Mobile Test Med"]')
         ).toBeVisible();
      ...
      test('should handle touch gestures correctly', async ({ page }) => {
         ...
         const medicationItem = page.locator(
            '[data-testid="medication-item-Swipe Med 1"]'
         );
         ...
         await expect(
            page.locator('[data-testid="swipe-delete-button"]')
         ).toBeVisible();
      ...
      test('should work offline on mobile', async ({ page, context }) => {
         ...
         await expect(
            page.locator('[data-testid="mobile-offline-banner"]')
         ).toBeVisible();
         ...
         await expect(
            page.locator('[data-testid="medication-item-Offline Med 2"]')
         ).toBeVisible();
   ...
   test.describe('Tablet Device Tests', () => {
      ...
      test('should utilize tablet screen space effectively', async ({
         page,
      }) => {
         ...
         await page.click('[data-testid="add-medication-button"]');
         await expect(
            page.locator('[data-testid="tablet-medication-form"]')
         ).toBeVisible();
   ...
   test.describe('Responsive Breakpoint Tests', () => {
      test('should adapt layout at different screen sizes', async ({
         page,
      }) => {
         ...
         await expect(
            page.locator('[data-testid="laptop-layout"]')
         ).toBeVisible();
         ...
         await expect(
            page.locator('[data-testid="small-mobile-layout"]')
         ).toBeVisible();
      ...
      test('should maintain functionality across all screen sizes', async ({
         ...
         for (const size of screenSizes) {
            ...
            await expect(
               page.locator(
                  `[data-testid="medication-item-${size.name} Test Med"]`
               )
            ).toBeVisible();
            ...
            await expect(
               page.locator('[data-testid="therapy-assessment-step"]')
            ).toBeVisible();
   ...
   test.describe('Accessibility Tests', () => {
      test('should be accessible on mobile devices', async ({ page }) => {
         ...
         await expect(
            page.locator('[data-testid="mtr-dashboard"]')
         ).toBeVisible();
      ...
      test('should support voice input on mobile', async ({ page }) => {
         ...
         if (
            await page.locator('[data-testid="voice-input-button"]').isVisible()
         ) {
            await page.click('[data-testid="voice-input-button"]');
            await expect(
               page.locator('[data-testid="voice-input-indicator"]')
            ).toBeVisible();
         }
