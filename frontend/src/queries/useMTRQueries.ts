 ...
 */
export const useMTRSessionsByPatient = (
   patientId: string,
 ...
 */
export const useActiveMTRSessions = (
   params: Omit<MTRSearchParams, 'status'> = {}
) => {
   return useQuery({
...
export const useCreateMTRSession = () => {
   ...
   return useMutation({
      mutationFn: (sessionData: CreateMTRData) =>
         mtrService.createMTRSession(sessionData),
      onSuccess: (data, variables) => {
         // Invalidate relevant queries
         queryClient.invalidateQueries({ queryKey: queryKeys.mtr.lists() });
         queryClient.invalidateQueries({
            queryKey: queryKeys.mtr.byPatient(variables.patientId),
         });
         ...
         if (newSession) {
            queryClient.setQueryData(
               queryKeys.mtr.detail(newSession._id),
               data
            );
         }
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to create MTR session. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onMutate: async ({ sessionId, sessionData }) => {
         ...
         const previousSession = queryClient.getQueryData(
            queryKeys.mtr.detail(sessionId)
         );
      ...
      onSuccess: (data, variables) => {
         ...
         queryClient.setQueryData(
            queryKeys.mtr.detail(variables.sessionId),
            data
         );
         ...
         if (session?.patientId) {
            queryClient.invalidateQueries({
               queryKey: queryKeys.mtr.byPatient(session.patientId),
            });
         }
      ...
      onError: (error: ApiError, variables, context) => {
         ...
         addNotification({
            ...
            message:
               error.message ||
               'Failed to update MTR session. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to delete MTR session. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to complete workflow step. Please try again.',
            duration: 5000,
         });
      },
   });
...
export const useCheckDrugInteractions = () => {
   ...
   return useMutation({
      mutationFn: (sessionId: string) =>
         mtrService.checkDrugInteractions(sessionId),
      onSuccess: (data) => {
 ...
 */
export const useDrugTherapyProblemsByPatient = (
   patientId: string,
   ...
   return useQuery({
      ...
      queryFn: () =>
         mtrService.getDrugTherapyProblemsByPatient(patientId, params),
      enabled: !!patientId,
      staleTime: 2 * 60 * 1000,
   });
};
 ...
 */
export const useActiveDrugTherapyProblems = (
...
export const useCreateDrugTherapyProblem = () => {
   ...
   return useMutation({
      mutationFn: (problemData: CreateDTPData) =>
         mtrService.createDrugTherapyProblem(problemData),
      onSuccess: (data, variables) => {
         // Invalidate relevant queries
         queryClient.invalidateQueries({
            queryKey: queryKeys.drugTherapyProblems.lists(),
         });
         queryClient.invalidateQueries({
            queryKey: queryKeys.drugTherapyProblems.byPatient(
               variables.patientId
            ),
         });
         queryClient.invalidateQueries({
         ...
         if (variables.reviewId) {
            queryClient.invalidateQueries({
               queryKey: queryKeys.drugTherapyProblems.byReview(
                  variables.reviewId
               ),
            });
            queryClient.invalidateQueries({
               queryKey: queryKeys.mtr.detail(variables.reviewId),
            });
         }
         ...
         addNotification({
            ...
            message:
               'Drug therapy problem has been successfully identified and recorded.',
            duration: 5000,
         });
      },
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to create drug therapy problem. Please try again.',
            duration: 5000,
         });
      },
   });
...
export const useUpdateDrugTherapyProblem = () => {
   ...
   return useMutation({
      ...
      onSuccess: (data, variables) => {
         ...
         queryClient.setQueryData(
            queryKeys.drugTherapyProblems.detail(variables.problemId),
            data
         );
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to update drug therapy problem. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to resolve drug therapy problem. Please try again.',
            duration: 5000,
         });
      },
   });
 ...
 */
export const useMTRInterventionsByReview = (
   reviewId: string,
 ...
 */
export const usePendingMTRInterventions = (
...
export const useCreateMTRIntervention = () => {
   ...
   return useMutation({
      mutationFn: (interventionData: CreateInterventionData) =>
         mtrService.createIntervention(interventionData),
      onSuccess: (data, variables) => {
         // Invalidate relevant queries
         queryClient.invalidateQueries({
            queryKey: queryKeys.mtrInterventions.lists(),
         });
         queryClient.invalidateQueries({
            queryKey: queryKeys.mtrInterventions.byReview(variables.reviewId),
         });
         queryClient.invalidateQueries({
            queryKey: queryKeys.mtrInterventions.byPatient(variables.patientId),
         });
         queryClient.invalidateQueries({
            queryKey: queryKeys.mtrInterventions.pending(),
         });
...
export const useCompleteMTRIntervention = () => {
   ...
   return useMutation({
      ...
      onSuccess: (data, variables) => {
         ...
         queryClient.setQueryData(
            queryKeys.mtrInterventions.detail(variables.interventionId),
            data
         );
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to complete intervention. Please try again.',
            duration: 5000,
         });
      },
   });
 ...
 */
export const useMTRFollowUpsByReview = (
   reviewId: string,
 ...
 */
export const useScheduledMTRFollowUps = (
...
export const useCreateMTRFollowUp = () => {
   ...
   return useMutation({
      mutationFn: (followUpData: CreateFollowUpData) =>
         mtrService.createFollowUp(followUpData),
      onSuccess: (data, variables) => {
         // Invalidate relevant queries
         queryClient.invalidateQueries({
            queryKey: queryKeys.mtrFollowUps.lists(),
         });
         queryClient.invalidateQueries({
            queryKey: queryKeys.mtrFollowUps.byReview(variables.reviewId),
         });
         queryClient.invalidateQueries({
            queryKey: queryKeys.mtrFollowUps.byPatient(variables.patientId),
         });
         queryClient.invalidateQueries({
            queryKey: queryKeys.mtrFollowUps.scheduled(),
         });
...
export const useCompleteMTRFollowUp = () => {
   ...
   return useMutation({
      ...
      onSuccess: (data, variables) => {
         ...
         queryClient.setQueryData(
            queryKeys.mtrFollowUps.detail(variables.followUpId),
            data
         );
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to reschedule follow-up. Please try again.',
            duration: 5000,
         });
      },
   });
 ...
 */
export const useMTRStatistics = (dateRange?: {
   start: string;
   end: string;
}) => {
   return useQuery({
 ...
 */
export const useDTPStatistics = (dateRange?: {
   start: string;
   end: string;
}) => {
   return useQuery({
 ...
 */
export const useInterventionStatistics = (dateRange?: {
   start: string;
   end: string;
}) => {
   return useQuery({
 ...
 */
export const useFollowUpStatistics = (dateRange?: {
   start: string;
   end: string;
}) => {
   return useQuery({
 ...
 */
export const useMTRSummaryReport = (
   filters: {
      startDate?: string;
      endDate?: string;
      pharmacistId?: string;
 ...
 */
export const useInterventionEffectivenessReport = (
   filters: {
      startDate?: string;
      endDate?: string;
      pharmacistId?: string;
 ...
 */
export const usePharmacistPerformanceReport = (
   filters: {
      startDate?: string;
      endDate?: string;
      pharmacistId?: string;
 ...
 */
export const useQualityAssuranceReport = (
   filters: {
      startDate?: string;
      endDate?: string;
   } = {}
 ...
 */
export const useOutcomeMetricsReport = (
   filters: {
      startDate?: string;
      endDate?: string;
      reviewType?: string;
