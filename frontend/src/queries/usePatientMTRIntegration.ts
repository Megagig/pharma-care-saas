...
import type { MTRMedicationEntry } from '../types/patientManagement';
 ...
 */
export const usePatientMTRSummary = (
   patientId: string,
   ...
   return useQuery({
      ...
      queryFn: () =>
         patientMTRIntegrationService.getPatientMTRSummary(patientId),
...
export const usePatientDataForMTR = (patientId: string) => {
   return useQuery({
      ...
      queryFn: () =>
         patientMTRIntegrationService.getPatientDataForMTR(patientId),
      enabled: !!patientId,
 ...
 */
export const usePatientDashboardMTRData = (
   patientId: string,
   enabled: boolean = true
) => {
   return useQuery({
      ...
      queryFn: () =>
         patientMTRIntegrationService.getPatientDashboardMTRData(patientId),
      enabled: !!patientId && enabled,
      staleTime: 5 * 60 * 1000, // 5 minutes
      cacheTime: 10 * 60 * 1000, // 10 minutes
      retry: (failureCount, error: ApiError) => {
...
export const useBulkPatientMTRStatus = (patientIds: string[]) => {
   return useQuery({
      ...
      queryFn: () =>
         patientMTRIntegrationService.getBulkPatientMTRStatus(patientIds),
   ...
   return useMutation({
      ...
      onSuccess: (data, variables) => {
         ...
         if (syncStatus === 'synced') {
            addNotification({
               ...
               message:
                  'Patient medications have been successfully synchronized with MTR.',
               duration: 4000,
            });
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to synchronize medications. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to import medications. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to export medications. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onSuccess: (data, variables) => {
         ...
         if (syncStatus === 'synced') {
            addNotification({
               ...
               message:
                  'Drug therapy problems have been successfully synchronized.',
               duration: 4000,
            });
         } else {
            addNotification({
               ...
               message:
                  'Some drug therapy problems need manual review and update.',
               duration: 5000,
            });
         }
      },
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message || 'Failed to synchronize DTPs. Please try again.',
            duration: 5000,
         });
      },
   });
...
export const useCreatePatientDTPFromMTR = () => {
   ...
   return useMutation({
      mutationFn: ({
         ...
         patientMTRIntegrationService.createPatientDTPFromMTR(
            patientId,
            mtrDTPId
         ),
      onSuccess: (data, variables) => {
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to create patient DTP. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to update MTR status. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to update patient MTR statuses. Please try again.',
            duration: 5000,
         });
      },
   });
...
export const useAddMTRSummaryToNotes = () => {
   ...
   return useMutation({
      mutationFn: ({
         ...
         patientMTRIntegrationService.addMTRSummaryToNotes(
            patientId,
            mtrId,
            summary
         ),
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message ||
               'Failed to add MTR summary to notes. Please try again.',
            duration: 5000,
         });
      },
   });
