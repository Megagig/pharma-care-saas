...
export const useClinicalIntervention = (interventionId: string) => {
   return useQuery({
      ...
      queryFn: () =>
         clinicalInterventionService.getInterventionById(interventionId),
...
export const useSearchClinicalInterventions = (searchQuery: string) => {
   return useQuery({
      ...
      queryFn: () =>
         clinicalInterventionService.searchInterventions(searchQuery),
...
export const usePatientInterventions = (patientId: string) => {
   return useQuery({
      ...
      queryFn: () =>
         clinicalInterventionService.getPatientInterventions(patientId),
      enabled: !!patientId,
      staleTime: 2 * 60 * 1000, // 2 minutes
   });
};
 ...
 */
export const useInterventionDashboard = (dateRange?: {
   start: string;
   end: string;
}) => {
   return useQuery({
...
export const useStrategyRecommendations = (category: string) => {
   return useQuery({
      ...
      queryFn: () =>
         clinicalInterventionService.getStrategyRecommendations(category),
      enabled: !!category,
 ...
 */
export const useDuplicateInterventions = (
   patientId: string,
   category: string
) => {
   return useQuery({
      ...
      queryFn: () =>
         clinicalInterventionService.checkDuplicates(patientId, category),
 ...
 */
export const useOutcomeTrends = (dateRange?: {
   start: string;
   end: string;
}) => {
   return useQuery({
   ...
   return useMutation({
      ...
      onSuccess: (response, variables) => {
         ...
         queryClient.invalidateQueries({
            queryKey: queryKeys.clinicalInterventions.all,
         });
         queryClient.invalidateQueries({
            queryKey: queryKeys.clinicalInterventions.lists(),
         });

         // Invalidate patient-specific interventions if patientId is provided
         if (variables.patientId) {
            queryClient.invalidateQueries({
               queryKey: queryKeys.clinicalInterventions.byPatient(
                  variables.patientId
               ),
            });
         }
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         ...
         addNotification({
            ...
            message:
               error.message ||
               'Failed to update intervention. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         ...
         addNotification({
            ...
            message:
               error.message ||
               'Failed to delete intervention. Please try again.',
            duration: 5000,
         });
      },
   });
   ...
   return useMutation({
      ...
      onError: (error: ApiError) => {
         addNotification({
            ...
            message:
               error.message || 'Unable to add strategy. Please try again.',
            duration: 5000,
         });
      },
   });
...
export const useUpdateStrategy = () => {
   ...
   return useMutation({
      mutationFn: ({
         ...
         clinicalInterventionService.updateStrategy(
            interventionId,
            strategyId,
            updates
         ),
...
export const useUpdateAssignment = () => {
   ...
   return useMutation({
      mutationFn: ({
         ...
         clinicalInterventionService.updateAssignment(
            interventionId,
            assignmentId,
            updates
         ),
   ...
   return {
      ...
      mutateAsync: async (data: CreateInterventionData) => {
         ...
         const previousData = queryClient.getQueryData(
            queryKeys.clinicalInterventions.lists()
         );
