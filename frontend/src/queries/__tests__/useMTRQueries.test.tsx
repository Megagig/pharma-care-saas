   ...
   describe('Query Hooks', () => {
      describe('useMTRSessions', () => {
         it('should fetch MTR sessions successfully', async () => {
            ...
            vi.mocked(mtrService.getMTRSessions).mockResolvedValue(
               mockSessions
            );
      ...
      describe('useMTRFollowUps', () => {
         it('should fetch MTR follow-ups successfully', async () => {
            ...
            const { mtrService } = await import('../../services/mtrService');
            vi.mocked(mtrService.getMTRFollowUps).mockResolvedValue(
               mockFollowUps
            );
            ...
            expect(mtrService.getMTRFollowUps).toHaveBeenCalledWith(
               'review-1',
               {}
            );
         });
   ...
   describe('Mutation Hooks', () => {
      describe('useCreateMTRSession', () => {
         it('should create MTR session successfully', async () => {
            ...
            expect(mtrService.createMTRSession).toHaveBeenCalledWith(
               createData
            );
         });
         ...
         it('should handle create MTR session error', async () => {
            ...
            await expect(
               result.current.mutateAsync(createData)
      ...
      describe('useUpdateMTRSession', () => {
         it('should update MTR session successfully', async () => {
            ...
            const { mtrService } = await import('../../services/mtrService');
            vi.mocked(mtrService.updateMTRSession).mockResolvedValue(
               mockResponse
            );
            ...
            expect(mtrService.updateMTRSession).toHaveBeenCalledWith(
               'session-1',
               {
                  status: 'completed',
               }
      ...
      describe('useCreateMTRFollowUp', () => {
         it('should create MTR follow-up successfully', async () => {
            ...
            const { mtrService } = await import('../../services/mtrService');
            vi.mocked(mtrService.createMTRFollowUp).mockResolvedValue(
               mockResponse
            );
            ...
            expect(mtrService.createMTRFollowUp).toHaveBeenCalledWith(
               createData
            );
         });
      });
   ...
   describe('Report Hooks', () => {
      describe('useMTRSummaryReport', () => {
         it('should fetch MTR summary report successfully', async () => {
            ...
            const { mtrService } = await import('../../services/mtrService');
            vi.mocked(mtrService.getMTRSummaryReport).mockResolvedValue(
               mockReport
            );
      ...
      describe('usePharmacistPerformanceReport', () => {
         it('should fetch pharmacist performance report successfully', async () => {
            ...
            const { mtrService } = await import('../../services/mtrService');
            vi.mocked(
               mtrService.getPharmacistPerformanceReport
            ).mockResolvedValue(mockReport);
