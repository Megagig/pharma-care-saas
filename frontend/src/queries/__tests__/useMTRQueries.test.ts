...
vi.mock('../../lib/queryClient', () => ({
    queryKeys: {
        mtr: {
            list: (params: any) => ['mtr', 'list', params],
            detail: (id: string) => ['mtr', 'detail', id],
            problems: (reviewId: string, params: any) => ['mtr', reviewId, 'problems', params],
            interventions: (reviewId: string, params: any) => ['mtr', reviewId, 'interventions', params],
            followUps: (reviewId: string, params: any) => ['mtr', reviewId, 'followUps', params],
            reports: {
                summary: (params: any) => ['mtr', 'reports', 'summary', params],
                interventions: (params: any) => ['mtr', 'reports', 'interventions', params],
                pharmacists: (params: any) => ['mtr', 'reports', 'pharmacists', params],
                quality: (params: any) => ['mtr', 'reports', 'quality', params],
                outcomes: (params: any) => ['mtr', 'reports', 'outcomes', params],
            },
        },
    },
}));
...
describe('useMTRQueries', () => {
    ...
    describe('Query Hooks', () => {
        describe('useMTRSessions', () => {
            ...
            it('should handle MTR sessions fetch error', async () => {
                const { mtrService } = await import('../../services/mtrService');
                vi.mocked(mtrService.getMTRSessions).mockRejectedValue(new Error('Network error'));
        ...
        describe('useDrugTherapyProblems', () => {
            it('should fetch drug therapy problems successfully', async () => {
                ...
                const { mtrService } = await import('../../services/mtrService');
                vi.mocked(mtrService.getDrugTherapyProblems).mockResolvedValue(mockProblems);

                const { result } = renderHook(() => useDrugTherapyProblems('review-1'), {
                    wrapper: createWrapper(),
                });
                ...
                expect(mtrService.getDrugTherapyProblems).toHaveBeenCalledWith('review-1', {});
            });
        });
        ...
        describe('useMTRInterventions', () => {
            it('should fetch MTR interventions successfully', async () => {
                ...
                const { mtrService } = await import('../../services/mtrService');
                vi.mocked(mtrService.getMTRInterventions).mockResolvedValue(mockInterventions);
                ...
                expect(mtrService.getMTRInterventions).toHaveBeenCalledWith('review-1', {});
            });
        });
    ...
    describe('Mutation Hooks', () => {
        describe('useCreateMTRSession', () => {
            ...
            it('should handle create MTR session error', async () => {
                const { mtrService } = await import('../../services/mtrService');
                vi.mocked(mtrService.createMTRSession).mockRejectedValue(new Error('Creation failed'));
                ...
                await expect(result.current.mutateAsync(createData)).rejects.toThrow('Creation failed');
            });
        });
        ...
        describe('useUpdateMTRSession', () => {
            it('should update MTR session successfully', async () => {
                ...
                expect(mtrService.updateMTRSession).toHaveBeenCalledWith('session-1', { status: 'completed' });
            });
        });
        ...
        describe('useCreateDrugTherapyProblem', () => {
            it('should create drug therapy problem successfully', async () => {
                ...
                const { mtrService } = await import('../../services/mtrService');
                vi.mocked(mtrService.createDrugTherapyProblem).mockResolvedValue(mockResponse);
                ...
                expect(mtrService.createDrugTherapyProblem).toHaveBeenCalledWith(createData);
            });
        });
        ...
        describe('useCreateMTRIntervention', () => {
            it('should create MTR intervention successfully', async () => {
                ...
                const { mtrService } = await import('../../services/mtrService');
                vi.mocked(mtrService.createMTRIntervention).mockResolvedValue(mockResponse);
                ...
                expect(mtrService.createMTRIntervention).toHaveBeenCalledWith(createData);
            });
        });
    ...
    describe('Report Hooks', () => {
        ...
        describe('useInterventionEffectivenessReport', () => {
            it('should fetch intervention effectiveness report successfully', async () => {
                ...
                const { mtrService } = await import('../../services/mtrService');
                vi.mocked(mtrService.getInterventionEffectivenessReport).mockResolvedValue(mockReport);

                const { result } = renderHook(() => useInterventionEffectivenessReport(), {
                    wrapper: createWrapper(),
                });
                ...
                expect(result.current.data).toEqual(mockReport);
                expect(mtrService.getInterventionEffectivenessReport).toHaveBeenCalledWith({});
            });
        });
        ...
        describe('usePharmacistPerformanceReport', () => {
            it('should fetch pharmacist performance report successfully', async () => {
                ...
                const { mtrService } = await import('../../services/mtrService');
                vi.mocked(mtrService.getPharmacistPerformanceReport).mockResolvedValue(mockReport);
        ...
        describe('useQualityAssuranceReport', () => {
            it('should fetch quality assurance report successfully', async () => {
                ...
                const { mtrService } = await import('../../services/mtrService');
                vi.mocked(mtrService.getQualityAssuranceReport).mockResolvedValue(mockReport);
        ...
        describe('useOutcomeMetricsReport', () => {
            it('should fetch outcome metrics report successfully', async () => {
                ...
                const { mtrService } = await import('../../services/mtrService');
                vi.mocked(mtrService.getOutcomeMetricsReport).mockResolvedValue(mockReport);
    ...
    describe('Error Handling', () => {
        ...
        it('should handle API validation errors', async () => {
            ...
            await expect(result.current.mutateAsync(createData)).rejects.toEqual(validationError);
        });
    });
