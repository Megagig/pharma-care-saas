                     ...
                     <Grid item xs={12} md={6}>
                        <Box sx={{ textAlign: 'center', p: 3 }}>
                           ...
                           <Typography
                              ...
                              sx={{ mb: 3 }}
                           >
                              Download a copy of all your data in a portable
                              format
                           </Typography>
                           <Button
                              variant="outlined"
         ...
         <Grid item xs={12}>
            <Card>
               ...
               <CardContent>
                  ...
                  <Alert severity="info">
                     <Typography variant="body2">
                        You're using 4.45 GB of 10 GB total storage. Upgrade to
                        get more space.
                     </Typography>
                  </Alert>
               </CardContent>
         ...
         >
            ...
            <DialogContent>
               <Alert severity="info" sx={{ mb: 2 }}>
                  We'll prepare your data export and send you a download link
                  via email. This process may take up to 24 hours.
               </Alert>
