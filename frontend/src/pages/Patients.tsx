      ...
      <Box sx={{ p: 3 }}>
         ...
         {isForMedications && (
            ...
            >
               ...
               <Typography variant="body2">
                  Select a patient from the list below to manage their
                  medications. Click the "Select" button in the Actions column
                  to proceed.
               </Typography>
            </Alert>
         )}
                        ...
                        <Select
                           ...
                           onChange={(e) =>
                              handleAdvancedFilter({
                                 bloodGroup:
                                    (e.target.value as BloodGroup) || undefined,
                              })
                           }
                        >
                     ...
                     <FormControl size="sm">
                        ...
                        <Select
                           ...
                           onChange={(e) =>
                              handleAdvancedFilter({
                                 genotype:
                                    (e.target.value as Genotype) || undefined,
                              })
                           }
                        >
         ...
         >
            <MenuItem
               onClick={() =>
                  selectedPatient && handleViewPatient(selectedPatient)
               }
            >
            ...
            <MenuItem
               onClick={() =>
                  selectedPatient && handleEditPatient(selectedPatient)
               }
            >
