              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@pharmacare.ng</p>
                    <p className="text-gray-600">sales@pharmacare.ng</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600">
                Simply sign up for a free trial account, verify your email, and
                you'll have immediate access to all features for 14 days.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600">
                ...
                and ongoing customer support to help you get the most out of
                PharmaCare.
              </p>
            </div>
          </div>
