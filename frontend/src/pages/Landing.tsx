      ...
      <Box sx={{ minHeight: '100vh', bgcolor: 'background.default' }}>
         ...
         >
            <Container maxWidth="lg">
               <Box sx={{ textAlign: 'center', maxWidth: '800px', mx: 'auto' }}>
                  ...
                  >
                     Empower your pharmacy practice with advanced patient
                     management, clinical documentation, and medication therapy
                     optimization tools designed specifically for pharmacists.
                  </Typography>
                  <Box
                     sx={{
                        display: 'flex',
         ...
         <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 } }}>
            <Box sx={{ textAlign: 'center', mb: 8 }}>
               ...
               >
                  Our comprehensive platform provides all the tools pharmacists
                  need to deliver exceptional patient care and optimize
