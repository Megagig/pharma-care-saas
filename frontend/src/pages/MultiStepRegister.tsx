                           ...
                           <FormControlLabel
                              ...
                              label={
                                 <Box>
                                    ...
                                    >
                                       Set up your pharmacy, hospital, clinic,
                                       or organization
                                    </Typography>
                                 </Box>
                              }
                              ...
                              label={
                                 <Box>
                                    ...
                                    <Typography
                                       ...
                                       color="text.secondary"
                                    >
                                       Use an invite code from your workplace
                                       owner
                                    </Typography>
                                 </Box>
                              }
                              ...
                              label={
                                 <Box>
                                    ...
                                    <Typography
                                       ...
                                       color="text.secondary"
                                    >
                                       Access general features only (Knowledge
                                       Hub, CPD, Forum)
                                    </Typography>
                                 </Box>
                              }
                        ...
                        <Box>
                           ...
                           >
                              ...
                              <Button
                                 ...
                                 disabled={
                                    loading || !joinForm.inviteCode.trim()
                                 }
                                 sx={{ minWidth: 120 }}
                              >
                                 {loading ? (
                     ...
                     <Stack spacing={2}>
                        ...
                        <Box>
                           ...
                           {workplaceFlow === 'join' && (
                              <Typography variant="body1">
                                 Joining:{' '}
                                 <strong>{foundWorkplace?.name}</strong> as{' '}
                        ...
                        {workplaceFlow === 'create' && (
                           <Alert severity="info" sx={{ mt: 2 }}>
                              🎉 You'll get a 14-day free trial to explore all
                              features!
                           </Alert>
                        )}
                        ...
                        {workplaceFlow === 'join' && (
                           <Alert severity="success" sx={{ mt: 2 }}>
                              🤝 You'll inherit your workplace's subscription
                              plan!
                           </Alert>
                        )}
                     </Stack>
