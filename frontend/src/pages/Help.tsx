         ...
         <Box sx={{ flex: '1 1 300px', minWidth: '300px' }}>
            ...
            <Card sx={{ mt: 3 }}>
               <CardHeader
                  ...
                  avatar={
                     <Badge
                        badgeContent="All Systems Operational"
                        color="success"
                     >
                        <SettingsIcon />
                     </Badge>
               ...
               <CardContent>
                  <Typography variant="body2" color="text.secondary" paragraph>
                     All PharmaCare services are running normally. Check our
            ...
            >
               <Box>
                  ...
                  <Typography variant="body1" color="textSecondary">
                     Find answers, learn about features, and get the support you
                     need
                  </Typography>
               </Box>
            </Box>
         ...
         >
            ...
            <DialogContent>
               ...
               <Typography variant="body2" paragraph>
                  Before starting the chat, please have the following
                  information ready:
               </Typography>
               <List dense>
