         ...
         <Paper elevation={3} sx={{ p: 4 }}>
            ...
            <Alert severity="info" sx={{ mb: 4 }}>
               <Typography variant="body2">
                  <strong>Development Mode:</strong> This is a simulated payment
                  page. In production, this would redirect to the actual Nomba
                  payment gateway.
               </Typography>
            </Alert>
            ...
            <Box sx={{ mt: 4, textAlign: 'center' }}>
               <Typography variant="caption" color="text.secondary">
                  This simulation will be replaced with real Nomba integration
                  in production
               </Typography>
            </Box>
         </Paper>
