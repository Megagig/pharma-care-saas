         ...
         {subscriptionStatus?.hasWorkspace && (
            <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }}>
               <Paper sx={{ p: 1, display: 'flex', borderRadius: 2 }}>
                  <Button
                     variant={
                        billingInterval === 'monthly' ? 'contained' : 'text'
                     }
                  ...
                  <Button
                     variant={
                        billingInterval === 'yearly' ? 'contained' : 'text'
                     }
                     ...
                     <Box sx={{ p: 3, pt: 0 }}>
                        {plan.isContactSales ? (
                           ...
                           <Button
                              fullWidth
                              variant={
                                 plan.popularPlan ? 'contained' : 'outlined'
                              }
            ...
            <DialogContent>
               {selectedPlan && (
                  <Box>
                     ...
                     <Typography variant="body2" color="text.secondary">
                        Your new features will be available immediately after
