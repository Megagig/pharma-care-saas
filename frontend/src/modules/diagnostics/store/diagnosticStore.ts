        ...
        (set, get) => ({
            ...
            createRequest: async (data: DiagnosticRequestForm) => {
                ...
                try {
                    ...
                    if (response.success && response.data) {
                        ...
                        setError('createRequest', response.message || 'Failed to create request');
                        return null;
                    }
                } catch (error) {
            ...
            fetchRequests: async (filters) => {
                ...
                try {
                    ...
                    if (response.success && response.data) {
                        ...
                        setError('fetchRequests', response.message || 'Failed to fetch requests');
                    }
                } catch (error) {
                    const errorMessage = error instanceof Error ? error.message : 'An unexpected error occurred';
            ...
            fetchResult: async (requestId: string) => {
                ...
                try {
                    ...
                    if (response.success && response.data) {
                        const existingResult = get().results.find(r => r._id === response.data!._id);
                        if (existingResult) {
                        ...
                        setError('fetchResult', response.message || 'Failed to fetch result');
                        return null;
                    }
                } catch (error) {
                    const errorMessage = error instanceof Error ? error.message : 'An unexpected error occurred';
            ...
            approveResult: async (resultId: string) => {
                ...
                try {
                    ...
                    if (response.success && response.data) {
                        ...
                        setError('approveResult', response.message || 'Failed to approve result');
                        return false;
                    }
                } catch (error) {
                    const errorMessage = error instanceof Error ? error.message : 'An unexpected error occurred';
            ...
            modifyResult: async (resultId: string, modifications: string) => {
                ...
                try {
                    ...
                    if (response.success && response.data) {
                        ...
                        setError('approveResult', response.message || 'Failed to modify result');
                        return false;
                    }
                } catch (error) {
                    const errorMessage = error instanceof Error ? error.message : 'An unexpected error occurred';
            ...
            rejectResult: async (resultId: string, reason: string) => {
                ...
                try {
                    ...
                    if (response.success && response.data) {
                        ...
                        setError('approveResult', response.message || 'Failed to reject result');
                        return false;
                    }
                } catch (error) {
                    const errorMessage = error instanceof Error ? error.message : 'An unexpected error occurred';
            ...
            cancelRequest: async (requestId: string) => {
                ...
                try {
                    ...
                    if (response.success && response.data) {
                        ...
                        setError('createRequest', response.message || 'Failed to cancel request');
                        return false;
                    }
                } catch (error) {
                    const errorMessage = error instanceof Error ? error.message : 'An unexpected error occurred';
            ...
            fetchAnalytics: async (params) => {
                ...
                try {
                    ...
                    if (response.success && response.data) {
                        ...
                        setError('fetchAnalytics', response.message || 'Failed to fetch analytics');
                    }
                } catch (error) {
                    const errorMessage = error instanceof Error ? error.message : 'An unexpected error occurred';
            ...
            updateRequestInState: (id: string, updates: Partial<DiagnosticRequest>) => {
                set((state) => ({
            ...
            getFilteredRequests: () => {
                ...
                if (filters.search) {
                    ...
                    filtered = filtered.filter(r =>
                        r.inputSnapshot.symptoms.subjective.some(s => s.toLowerCase().includes(searchLower)) ||
                        r.inputSnapshot.symptoms.objective.some(s => s.toLowerCase().includes(searchLower))
                    );
                }
