...
describe('ClinicalInterventionService', () => {
   ...
   describe('getInterventionById', () => {
      ...
      it('should fetch intervention by ID', async () => {
         ...
         expect(mockedAxios.get).toHaveBeenCalledWith(
            '/api/clinical-interventions/intervention-1'
         );
         expect(result).toEqual(
            mockInterventionResponse.data.data.intervention
         );
      });
      ...
      it('should handle not found error', async () => {
         ...
         await expect(
            clinicalInterventionService.getInterventionById('nonexistent')
         ).rejects.toThrow();
      });
   });
   ...
   describe('createIntervention', () => {
      ...
      it('should create intervention with valid data', async () => {
         ...
         const interventionData = {
            ...
            priority: 'high',
            issueDescription:
               'Patient experiencing side effects from current medication',
            strategies: [],
   ...
   describe('updateIntervention', () => {
      ...
      it('should update intervention with valid data', async () => {
         ...
         const result = await clinicalInterventionService.updateIntervention(
            'intervention-1',
            updates
         );
      ...
      it('should handle update errors', async () => {
         ...
         await expect(
            clinicalInterventionService.updateIntervention('intervention-1', {
               priority: 'low',
            })
         ).rejects.toThrow();
      });
   ...
   describe('deleteIntervention', () => {
      ...
      it('should delete intervention', async () => {
         ...
         const result =
            await clinicalInterventionService.deleteIntervention(
               'intervention-1'
            );
      ...
      it('should handle delete errors', async () => {
         ...
         await expect(
            clinicalInterventionService.deleteIntervention('intervention-1')
         ).rejects.toThrow();
      });
   });
   ...
   describe('addStrategy', () => {
      ...
      it('should add strategy to intervention', async () => {
         ...
         const result = await clinicalInterventionService.addStrategy(
            'intervention-1',
            strategy
         );
   ...
   describe('assignTeamMember', () => {
      ...
      it('should assign team member to intervention', async () => {
         ...
         const result = await clinicalInterventionService.assignTeamMember(
            'intervention-1',
            assignment
         );
   ...
   describe('recordOutcome', () => {
      ...
      it('should record intervention outcome', async () => {
         ...
         const result = await clinicalInterventionService.recordOutcome(
            'intervention-1',
            outcome
         );
   ...
   describe('scheduleFollowUp', () => {
      ...
      it('should schedule follow-up for intervention', async () => {
         ...
         const result = await clinicalInterventionService.scheduleFollowUp(
            'intervention-1',
            followUp
         );
   ...
   describe('getPatientInterventions', () => {
      ...
      it('should fetch patient interventions with summary', async () => {
         ...
         const result =
            await clinicalInterventionService.getPatientInterventions(
               'patient-1'
            );

         expect(mockedAxios.get).toHaveBeenCalledWith(
            '/api/clinical-interventions/patient/patient-1',
            {
               params: {
                  page: 1,
                  limit: 20,
   ...
   describe('searchPatients', () => {
      ...
      it('should search patients with intervention context', async () => {
         ...
         const result =
            await clinicalInterventionService.searchPatients('John');

         expect(mockedAxios.get).toHaveBeenCalledWith(
            '/api/clinical-interventions/search/patients',
            {
               params: {
                  q: 'John',
                  limit: 10,
