...
const mockApiHelpers = apiHelpers as unknown as {
   ...
   transformDatesForFrontend: vi.MockedFunction<
      typeof apiHelpers.transformDatesForFrontend
   >;
   transformDatesForAPI: vi.MockedFunction<
      typeof apiHelpers.transformDatesForAPI
   >;
};
...
describe('mtrService', () => {
   ...
   describe('MTR Session Operations', () => {
      describe('getMTRSessions', () => {
         ...
         it('should handle API errors', async () => {
            ...
            await expect(mtrService.getMTRSessions()).rejects.toThrow(
               'Network error'
            );
         });
      });
      ...
      describe('getMTRSession', () => {
         it('should fetch single MTR session successfully', async () => {
            ...
            expect(mockApiHelpers.get).toHaveBeenCalledWith(
               '/api/mtr/session-1'
            );
            expect(result).toEqual(mockResponse);
         });
         ...
         it('should handle not found error', async () => {
            ...
            await expect(
               mtrService.getMTRSession('invalid-id')
            ).rejects.toThrow(MTRNotFoundError);
         });
      });
         ...
         it('should handle conflict errors', async () => {
            ...
            const error = {
               response: {
                  ...
                  data: {
                     message:
                        'Active MTR session already exists for this patient',
                  },
               },
            };
      ...
      describe('updateMTRSession', () => {
         it('should update MTR session successfully', async () => {
            ...
            const result = await mtrService.updateMTRSession(
               'session-1',
               updateData
            );
      ...
      describe('deleteMTRSession', () => {
         it('should delete MTR session successfully', async () => {
            ...
            expect(mockApiHelpers.delete).toHaveBeenCalledWith(
               '/api/mtr/session-1'
            );
            expect(result).toEqual(mockResponse);
         });
   ...
   describe('Drug Therapy Problem Operations', () => {
      ...
      describe('createDrugTherapyProblem', () => {
         it('should create drug therapy problem successfully', async () => {
            ...
            const result =
               await mtrService.createDrugTherapyProblem(createData);
      ...
      describe('updateDrugTherapyProblem', () => {
         it('should update drug therapy problem successfully', async () => {
            ...
            const result =
               await mtrService.updateDrugTherapyProblem(updateData);
   ...
   describe('Reporting Operations', () => {
      ...
      describe('getInterventionEffectivenessReport', () => {
         it('should fetch intervention effectiveness report successfully', async () => {
            ...
            const result =
               await mtrService.getInterventionEffectivenessReport();

            expect(mockApiHelpers.get).toHaveBeenCalledWith(
               '/api/mtr/reports/outcomes',
               {
                  params: {},
               }
            );
   ...
   describe('Error Handling', () => {
      ...
      it('should handle 404 not found errors', async () => {
         ...
         await expect(mtrService.getMTRSession('invalid-id')).rejects.toThrow(
            MTRNotFoundError
         );
      });
   ...
   describe('Request Validation', () => {
      it('should validate required fields for createMTRSession', async () => {
         ...
         await expect(
            mtrService.createMTRSession(invalidData)
         ).rejects.toThrow();
      });
      ...
      it('should validate medication data for drug interaction check', async () => {
         ...
         await expect(
            mtrService.checkDrugInteractions(invalidMedications)
         ).rejects.toThrow();
      });
   });
