...
class ClinicalInterventionService {
   ...
   async getInterventions(
   ...
   ): Promise<PaginatedResponse<ClinicalIntervention>> {
      ...
      return this.makeRequest<PaginatedResponse<ClinicalIntervention>['data']>(
         url
      );
   }
   ...
   async getInterventionById(
      id: string
   ): Promise<ApiResponse<ClinicalIntervention>> {
      return this.makeRequest<ClinicalIntervention>(
         `/clinical-interventions/${id}`
      );
   }
   ...
   async addStrategy(
      ...
      return this.makeRequest<ClinicalIntervention>(
         `/clinical-interventions/${interventionId}/strategies`,
         {
            method: 'POST',
   ...
   async updateStrategy(
      ...
      return this.makeRequest<ClinicalIntervention>(
         `/clinical-interventions/${interventionId}/strategies/${strategyId}`,
         {
            method: 'PATCH',
            body: JSON.stringify(updates),
         }
   ...
   async assignTeamMember(
      ...
      return this.makeRequest<ClinicalIntervention>(
         `/clinical-interventions/${interventionId}/assignments`,
         {
            method: 'POST',
   ...
   async updateAssignment(
      ...
      return this.makeRequest<ClinicalIntervention>(
         `/clinical-interventions/${interventionId}/assignments/${assignmentId}`,
         {
            method: 'PATCH',
            body: JSON.stringify(updates),
         }
   ...
   async recordOutcome(
      ...
      return this.makeRequest<ClinicalIntervention>(
         `/clinical-interventions/${interventionId}/outcomes`,
         {
            method: 'POST',
   ...
   async scheduleFollowUp(
      ...
      return this.makeRequest<ClinicalIntervention>(
         `/clinical-interventions/${interventionId}/follow-up`,
         {
            method: 'POST',
   ...
   async searchInterventions(
      ...
      return this.makeRequest<ClinicalIntervention[]>(
         `/clinical-interventions/search?q=${encodeURIComponent(query)}`
      );
   }
   ...
   async getPatientInterventions(
      ...
      return this.makeRequest<ClinicalIntervention[]>(
         `/clinical-interventions/patient/${patientId}`
      );
   }
    ...
    */
   async getMyAssignedInterventions(): Promise<
      ApiResponse<ClinicalIntervention[]>
   > {
      return this.makeRequest<ClinicalIntervention[]>(
         '/clinical-interventions/assigned-to-me'
      );
   }
   ...
   async getStrategyRecommendations(
      category: string
   ): Promise<ApiResponse<StrategyRecommendation[]>> {
      return this.makeRequest<StrategyRecommendation[]>(
         `/clinical-interventions/recommendations/${category}`
      );
   }
    ...
    * Get outcome trends
    */
   async getOutcomeTrends(dateRange?: {
      start: string;
      end: string;
   ...
   async linkToMTR(
      ...
      return this.makeRequest<ClinicalIntervention>(
         `/clinical-interventions/${interventionId}/link-mtr`,
         {
            method: 'POST',
   ...
   async sendNotifications(
      ...
      return this.makeRequest<boolean>(
         `/clinical-interventions/${interventionId}/notifications`,
         {
            method: 'POST',
   ...
   async checkDuplicates(
      ...
      return this.makeRequest<ClinicalIntervention[]>(
         `/clinical-interventions/check-duplicates?patientId=${patientId}&category=${category}`
      );
   }
   ...
   async getCategoryCounts(): Promise<ApiResponse<Record<string, number>>> {
      return this.makeRequest<Record<string, number>>(
         '/clinical-interventions/analytics/categories'
      );
   }
   ...
   > {
      return this.makeRequest<Record<string, number>>(
         '/clinical-interventions/analytics/priorities'
      );
   }
   // ===============================
    ...
    */
   async getMTRReference(interventionId: string): Promise<
      ApiResponse<{
         mtrReference: {
            _id: string;
            reviewNumber: string;
   ...
   > {
      return this.makeRequest(
         `/clinical-interventions/${interventionId}/mtr-reference`
      );
   }
    ...
    */
   async getInterventionsForMTR(mtrId: string): Promise<
      ApiResponse<{
         interventions: ClinicalIntervention[];
         count: number;
         mtrId: string;
   ...
   async syncWithMTR(interventionId: string): Promise<ApiResponse<null>> {
      return this.makeRequest(
         `/clinical-interventions/${interventionId}/sync-mtr`,
         {
            method: 'POST',
         }
      );
   ...
   > {
      ...
      return this.makeRequest(
         `/clinical-interventions/compliance/report?${params.toString()}`
      );
   }
