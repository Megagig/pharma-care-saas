...
interface ClinicalInterventionStore {
   ...
   ) => Promise<ClinicalIntervention | null>;
   updateIntervention: (
      id: string,
   ...
   selectPatient: (
      patient: ClinicalInterventionStore['selectedPatient']
   ) => void;
   ...
   updateInterventionInState: (
      id: string,
      updates: Partial<ClinicalIntervention>
   ) => void;
      ...
      (set, get) => ({
         ...
         fetchInterventions: async (filters) => {
            ...
            try {
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     'fetchInterventions',
                     response.message || 'Failed to fetch interventions'
                  );
               }
            } catch (error) {
               setError(
         ...
         createIntervention: async (data) => {
            ...
            try {
               ...
               const response =
                  await clinicalInterventionService.createIntervention(data);
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     'createIntervention',
                     response.message || 'Failed to create intervention'
                  );
                  return null;
               }
            } catch (error) {
         ...
         updateIntervention: async (id, updates) => {
            ...
            try {
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     'updateIntervention',
                     response.message || 'Failed to update intervention'
                  );
                  return null;
               }
            } catch (error) {
         ...
         deleteIntervention: async (id) => {
            ...
            try {
               ...
               const response =
                  await clinicalInterventionService.deleteIntervention(id);
               ...
               if (response.success) {
                  ...
                  setError(
                     'deleteIntervention',
                     response.message || 'Failed to delete intervention'
                  );
                  return false;
               }
            } catch (error) {
         ...
         getInterventionById: async (id) => {
            ...
            try {
               ...
               const response =
                  await clinicalInterventionService.getInterventionById(id);
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     'getInterventionById',
                     response.message || 'Failed to fetch intervention'
                  );
                  return null;
               }
            } catch (error) {
         ...
         addStrategy: async (interventionId, strategy) => {
            ...
            try {
               ...
               const response = await clinicalInterventionService.addStrategy(
                  interventionId,
                  strategy
               );
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     'addStrategy',
                     response.message || 'Failed to add strategy'
                  );
               }
            } catch (error) {
               setError(
         ...
         updateStrategy: async (interventionId, strategyId, updates) => {
            ...
            try {
               ...
               const response =
                  await clinicalInterventionService.updateStrategy(
                     interventionId,
                     strategyId,
                     updates
                  );
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     'updateStrategy',
                     response.message || 'Failed to update strategy'
                  );
               }
            } catch (error) {
               setError(
         ...
         assignTeamMember: async (interventionId, assignment) => {
            ...
            try {
               ...
               const response =
                  await clinicalInterventionService.assignTeamMember(
                     interventionId,
                     assignment
                  );
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     'assignTeamMember',
                     response.message || 'Failed to assign team member'
                  );
               }
            } catch (error) {
               setError(
         ...
         updateAssignment: async (interventionId, assignmentId, updates) => {
            ...
            try {
               ...
               const response =
                  await clinicalInterventionService.updateAssignment(
                     interventionId,
                     assignmentId,
                     updates
                  );
         ...
         recordOutcome: async (interventionId, outcome) => {
            ...
            try {
               ...
               const response = await clinicalInterventionService.recordOutcome(
                  interventionId,
                  outcome
               );
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     'recordOutcome',
                     response.message || 'Failed to record outcome'
                  );
               }
            } catch (error) {
               setError(
         ...
         scheduleFollowUp: async (interventionId, followUpData) => {
            ...
            try {
               ...
               const response =
                  await clinicalInterventionService.scheduleFollowUp(
                     interventionId,
                     followUpData
                  );
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     'scheduleFollowUp',
                     response.message || 'Failed to schedule follow-up'
                  );
               }
            } catch (error) {
               setError(
         ...
         getMyAssignedInterventions: async () => {
            ...
            try {
               ...
               const response =
                  await clinicalInterventionService.getMyAssignedInterventions();
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     ...
                     response.message ||
                        'Failed to fetch assigned interventions'
                  );
               }
            } catch (error) {
               setError(
         ...
         fetchDashboardMetrics: async (dateRange) => {
            ...
            try {
               ...
               const response =
                  await clinicalInterventionService.getDashboardMetrics(
                     dateRange
                  );
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     ...
                     response.message || 'Failed to fetch dashboard metrics'
                  );
               }
            } catch (error) {
               setError(
         ...
         getStrategyRecommendations: async (category) => {
            ...
            try {
               ...
               const response =
                  await clinicalInterventionService.getStrategyRecommendations(
                     category
                  );
               ...
               if (response.success && response.data) {
                  ...
                  setError(
                     ...
                     response.message ||
                        'Failed to fetch strategy recommendations'
                  );
               }
            } catch (error) {
               setError(
...
export const useInterventions = () =>
   useClinicalInterventionStore((state) => ({
...
export const useSelectedIntervention = () =>
   useClinicalInterventionStore((state) => ({
      selectedIntervention: state.selectedIntervention,
...
export const useInterventionWorkflow = () =>
   useClinicalInterventionStore((state) => ({
...
export const useInterventionUI = () =>
   useClinicalInterventionStore((state) => ({
      activeStep: state.activeStep,
...
export const useInterventionAnalytics = () =>
   useClinicalInterventionStore((state) => ({
      ...
      loading: {
         ...
         strategyRecommendations:
            state.loading.getStrategyRecommendations || false,
      },
      errors: {
         dashboardMetrics: state.errors.fetchDashboardMetrics || null,
         strategyRecommendations:
            state.errors.getStrategyRecommendations || null,
      },
   }));
