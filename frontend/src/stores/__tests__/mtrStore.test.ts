...
describe('MTRStore', () => {
   ...
   describe('Medication Management', () => {
      ...
      it('should validate medications', () => {
         ...
         expect(validateMedications()).toContain(
      ...
      it('should detect duplicate medications', () => {
         ...
         const state = useMTRStore.getState();
         const duplicates = state.medications.filter(
            (med) => med.drugName === mockMedication.drugName
         );
   ...
   describe('Problem Management', () => {
      ...
      it('should resolve a problem', () => {
         ...
         expect(state.identifiedProblems[0].resolution?.action).toBe(
   ...
   describe('Utility Functions', () => {
      ...
      it('should validate step completion', () => {
         ...
         expect(validateStep(1)).toContain(
            'At least one medication is required'
         );
      });
   });
