...
export const useDrugStore = create<DrugState>()((set) => ({
   ...
   setDrugInteractions: (interactions) =>
      set({ drugInteractions: interactions }),
   ...
   setIsLoadingAdverseEffects: (loading) =>
      set({ isLoadingAdverseEffects: loading }),
   setIsLoadingFormulary: (loading) => set({ isLoadingFormulary: loading }),
   setIsLoadingTherapyPlans: (loading) =>
      set({ isLoadingTherapyPlans: loading }),
