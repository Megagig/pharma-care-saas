         ...
         return (
            <>
               ...
               >
                  ...
                  official indication information for {drugName}. This could
                  happen if:
               </Typography>
               <ul style={{ color: '#666', marginTop: '8px' }}>
                  <li>The drug name has an alternate spelling or format</li>
                  <li>
                     The drug may be known by another name in the FDA database
                  </li>
                  <li>
                     There may be a temporary connection issue with the FDA
                     database
                  </li>
               </ul>
               <Typography variant="body2" sx={{ mt: 2, fontStyle: 'italic' }}>
                  Always consult with a healthcare professional before starting
                  or changing medication. Indications may vary based on
                  formulation, dosage, and individual patient factors.
               </Typography>
            </>
         );
      }
                     ...
                     {result.indications_and_usage.map(
                        (indication: string, idx: number) => (
                           <React.Fragment key={idx}>
                              ...
                              {idx <
                                 result.indications_and_usage.length - 1 && (
