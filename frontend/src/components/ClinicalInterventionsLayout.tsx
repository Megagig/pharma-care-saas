      ...
      <Container maxWidth="xl" sx={{ py: 3 }}>
         ...
         <Box sx={{ mb: 3 }}>
            ...
            <Typography variant="body1" color="text.secondary">
               Comprehensive clinical intervention management and workflow
               system
            </Typography>
         </Box>
         ...
         <Routes>
            <Route
               ...
               element={
                  <Navigate
                     to="/pharmacy/clinical-interventions/dashboard"
                     replace
                  />
               }
            />
            <Route
               path="/dashboard"
               element={<ClinicalInterventionDashboard />}
            />
            ...
            <Route
               path="/details/:id"
               element={<ClinicalInterventionDetails />}
            />
            <Route path="/patients" element={<PatientInterventions />} />
            <Route
               path="/patients/:patientId"
               element={<PatientInterventions />}
            />
