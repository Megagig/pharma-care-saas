                                    ...
                                    <ListItemText
                                       ...
                                       secondary={
                                          ...
                                          >
                                             ...
                                             •
                                             {
                                                mtr.completionPercentage as number
                                             }
                                             % complete
                                          </Typography>
                                       }
                        ...
                        <Box>
                           ...
                           <List dense>
                              {pendingActions
                                 .slice(0, 3)
                                 .map(
                                    (action: PendingAction, index: number) => (
                                       <ListItem key={index}>
                                          <ListItemIcon>
                                             <ScheduleIcon
                                                color={
                           ...
                           <List dense>
                              {recentMTRs.slice(0, 3).map((mtr: MTRSession) => (
                                 <ListItem
                                    ...
                                    component="div"
                                    onClick={() =>
                                       handleViewMTR(mtr._id as string)
                                    }
                                    sx={{ cursor: 'pointer' }}
                                 >
                                    <ListItemIcon>
                  ...
                  {(!mtrSummary || mtrSummary.totalMTRSessions === 0) && (
                     <Box sx={{ textAlign: 'center', py: 3 }}>
                        ...
                        <Typography
                           ...
                           sx={{ mb: 2 }}
                        >
                           Start the first medication therapy review for this
                           patient
                        </Typography>
                        <Button
                           variant="contained"
         ...
         <Dialog open={showSyncDialog} onClose={() => setShowSyncDialog(false)}>
            ...
            <DialogContent>
               <Typography variant="body2" sx={{ mb: 2 }}>
                  This will synchronize the patient's medications and drug
                  therapy problems with the selected MTR session. Any conflicts
                  will be highlighted for manual resolution.
               </Typography>
               <Alert severity="info">
                  <Typography variant="body2">
            ...
            <DialogActions>
               ...
               <Button
                  ...
                  disabled={
                     syncMedicationsMutation.isPending ||
                     syncDTPsMutation.isPending
                  }
                  startIcon={<SyncIcon />}
               >
                  Sync Data
