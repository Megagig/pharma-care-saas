         ...
         <Box>
                     ...
                     >
                        ...
                        <Box sx={{ minWidth: 150 }}>
                           <Typography variant="body2" color="text.secondary">
                              {filteredConditions.length} of {conditions.length}{' '}
                              shown
                           </Typography>
                        </Box>
                     </Box>
            ...
            >
               ...
               <DialogContent dividers>
                  <Box
                     component="form"
                     onSubmit={handleSubmit(handleSaveCondition)}
                  >
                     <Stack spacing={3}>
                        {/* Condition Name */}
                        <Controller
                           ...
                           rules={{
                              ...
                              maxLength: {
                                 value: 100,
                                 message:
                                    'Condition name cannot exceed 100 characters',
                              },
                           }}
                           render={({ field }) => (
                              <Autocomplete
                        ...
                        {watch('status') && (
                           ...
                           >
                              <Typography variant="body2">
                                 <strong>
                                    {getStatusConfig(watch('status')).label}{' '}
                                    Status:
                                 </strong>{' '}
                                 {watch('status') === 'active' &&
