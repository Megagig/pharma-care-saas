...
const MedicationSettingsPanel: React.FC<MedicationSettingsPanelProps> = ({
   ...
   React.useEffect(() => {
      if (settings) {
         ...
         setMonitoringSettings((prev) => ({
            ...prev,
            adherenceMonitoring:
               settings.monitoringSettings.adherenceMonitoring,
            refillReminders: settings.monitoringSettings.refillReminders,
            interactionChecking:
               settings.monitoringSettings.interactionChecking,
         }));
      }
   }, [settings]);
   ...
   const handleAddReminderTime = () => {
      setReminderSettings({
         ...reminderSettings,
         defaultReminderTimes: [
            ...reminderSettings.defaultReminderTimes,
            '12:00',
         ],
      });
   };
         ...
         <Paper sx={{ p: 3, mb: 4 }}>
            <Grid container spacing={3}>
               <Grid sx={{ gridColumn: 'span 12' }} component="div">
                  ...
                  />
                  <FormHelperText>
                     When enabled, reminders will be sent based on the schedule
                     below
                  </FormHelperText>
               </Grid>
                  ...
                  <FormControl fullWidth>
                     ...
                     <Select
                        ...
                        onChange={(e) =>
                           setReminderSettings({
                              ...reminderSettings,
                              reminderMethod: e.target.value as
                                 | 'email'
                                 | 'sms'
                                 | 'both',
                           })
               ...
               <Grid sx={{ gridColumn: 'span 12' }} component="div">
                  ...
                  <Box sx={{ mb: 2 }}>
                     <Typography variant="body2" color="text.secondary">
                        These times will be used as defaults when setting up
            ...
            <Grid container spacing={3}>
               ...
               <Grid sx={{ gridColumn: 'span 12' }} component="div">
                  <Button
                     ...
                     disabled={
                        !testContactInfo || testNotificationMutation.isPending
                     }
                  >
