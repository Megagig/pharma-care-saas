      ...
      try {
         ...
         if (currentMedicationId) {
            ...
            await createMutation.mutateAsync(
               createData as MedicationCreateData
            );
         }
      ...
      <Box sx={{ p: 2 }}>
         ...
         {isLoadingPatient ? (
            ...
            <Alert severity="error" sx={{ mb: 3 }}>
               Error loading patient information. Please try refreshing the
               page.
            </Alert>
                  ...
                  <Box>
                     ...
                     >
                        <Typography variant="body2">
                           <strong>MRN:</strong>{' '}
                           {patientData.data.patient.mrn ||
                              patientData.data.patient._id}
                        </Typography>
                        <Typography variant="body2">
                           <strong>DOB:</strong>{' '}
               ...
               <Box sx={{ p: 2 }}>
                  {activeMedications.length === 0 ? (
                     <Typography variant="body1" sx={{ py: 2 }}>
                        No active medications found. Click "Add Medication" to
                        get started.
                     </Typography>
                  ) : (
                     <MedicationList
                     ...
                     {interactions.length > 0 && (
                        <Grid sx={{ gridColumn: 'span 12' }}>
                           <Alert severity="warning" sx={{ mt: 2 }}>
                              ...
                              <Box sx={{ mt: 1 }}>
                                 Override and continue? Check with prescriber
                                 first.
                              </Box>
                           </Alert>
                        </Grid>
                  ...
                  <Box sx={{ p: 1 }}>
                     ...
                     {reminders.length === 0 ? (
                        <Alert severity="info" sx={{ my: 2 }}>
                           No reminders set for this medication. Add a reminder
                           to help the patient stay on schedule.
                        </Alert>
                     ) : (
         ...
         >
            ...
            <DialogContent>
               <Typography>
                  Are you sure you want to archive this medication? This will
                  mark it as no longer active, but the record will be preserved
               ...
               <Grid container spacing={3}>
                     ...
                     <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <ResponsiveContainer width="100%" height={300}>
                           <PieChart>
                              <Pie
                                 data={
                                    mockPrescriptionData.medicationsByCategory
                                 }
                                 cx="50%"
                                 cy="50%"
                                 labelLine={false}
                  ...
                  <Grid sx={{ gridColumn: 'span 12' }}>
                     <Paper sx={{ p: 2 }}>
                        ...
                        <ResponsiveContainer width="100%" height={300}>
                           <BarChart
                              data={mockPrescriptionData.prescriptionFrequency}
                           >
                              <CartesianGrid strokeDasharray="3 3" />
                              <XAxis dataKey="month" />
                              <YAxis />
               ...
               <Grid container spacing={3}>
                  ...
                  <Grid sx={{ gridColumn: { xs: 'span 12', md: 'span 6' } }}>
                     <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <ResponsiveContainer width="100%" height={300}>
                           <LineChart
                              data={mockInteractionData.interactionTrends}
                           >
                              <CartesianGrid strokeDasharray="3 3" />
                              <XAxis dataKey="month" />
                              <YAxis />
