                        ...
                        <Stack spacing={3}>
                           ...
                           <Alert severity="info">
                              <Typography variant="body2">
                                 ...
                                 group and genotype are important for emergency
                                 situations and medication compatibility. Weight
                                 is used for dosage calculations.
                                 {watch('genotype')?.includes('S') && (
                                    ...
                                    >
                                       ⚠️ Sickle cell genotype detected -
