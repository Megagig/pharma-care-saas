                     ...
                     >
                        ...
                        <Stack direction="row" spacing={1}>
                           <Chip
                              ...
                              size="small"
                              color={getPlanQualityColor(
                                 latestCarePlan.planQuality
                              )}
                              icon={
                                 latestCarePlan.planQuality === 'adequate' ? (
                                    <CheckCircleIcon />
                           ...
                           <RBACGuard action="canUpdate">
                              <IconButton
                                 size="small"
                                 onClick={() =>
                                    handleOpenDialog(latestCarePlan)
                                 }
                              >
               ...
               <Card>
                  <CardContent sx={{ textAlign: 'center', py: 6 }}>
                     ...
                     <Typography
                        ...
                        sx={{ mb: 3 }}
                     >
                        Create a comprehensive care plan to guide patient
                                 ...
                                 <Controller
                                    ...
                                    rules={{
                                       ...
                                       maxLength: {
                                          value: 200,
                                          message:
                                             'Objective cannot exceed 200 characters',
                                       },
                                    }}
                                    render={({ field }) => (
                                       <TextField
