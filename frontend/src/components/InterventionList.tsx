               ...
               <TableRow>
                  ...
                  <TableCell>
                     <TableSortLabel
                        ...
                        direction={
                           sortField === 'identifiedDate' ? sortOrder : 'asc'
                        }
               ...
               {isLoading ? (
                  ...
                  interventions.map((intervention) => (
                     <TableRow
                        ...
                        hover
                        selected={selectedInterventions.includes(
                           intervention._id
                        )}
                     >
                        <TableCell padding="checkbox">
                        ...
                        <TableCell>
                           <Chip
                              ...
                              sx={{
                                 bgcolor:
                                    PRIORITY_LEVELS[intervention.priority]
                                       ?.color + '20',
                                 color: PRIORITY_LEVELS[intervention.priority]
                                    ?.color,
                                 fontWeight: 'medium',
                              }}
                           />
                        ...
                        <TableCell>
                           <Chip
                              ...
                              sx={{
                                 bgcolor:
                                    STATUS_LABELS[intervention.status]?.color +
                                    '20',
                                 color: STATUS_LABELS[intervention.status]
                                    ?.color,
                                 fontWeight: 'medium',
                              }}
                           />
