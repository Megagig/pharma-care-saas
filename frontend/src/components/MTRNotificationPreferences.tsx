      ...
      <Card>
         <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" mb={3}>
               Configure how you want to receive notifications for Medication
               Therapy Review activities.
            </Typography>
            ...
            <Alert severity="info" sx={{ mb: 3 }}>
               <Typography variant="body2">
                  ...
                  <ul style={{ margin: '8px 0', paddingLeft: '20px' }}>
                     <li>
                        Critical alerts will always be sent via email regardless
                        of your preferences for urgent safety issues.
                     </li>
                     <li>
                        SMS notifications require a valid phone number in your
                        profile.
                     </li>
                     <li>
                        You can test your notification settings using the test
                        buttons above.
                     </li>
                  </ul>
               </Typography>
