         ...
         <Card>
            <CardContent sx={{ textAlign: 'center', py: 6 }}>
               ...
               <Typography variant="body2" color="text.secondary">
                  Please complete the therapy assessment step to identify
                  problems before developing a plan
               </Typography>
            </CardContent>
         </Card>
      );
                           ...
                           {recommendationFields.length === 0 && (
                              ...
                              >
                                 <Typography
                                    ...
                                    color="text.secondary"
                                 >
                                    No recommendations added yet. Click "Add
                                 ...
                                 >
                                    ...
                                    <Stack direction="row" spacing={1}>
                                       <IconButton
                                          size="small"
                                          onClick={() =>
                                             handleAddMonitoring(monitoring)
                                          }
                                       >
                                          <EditIcon />
                                       </IconButton>
                        ...
                        <FixedGrid item xs={12}>
                           ...
                           >
                              <Typography
                                 ...
                                 color="text.secondary"
                              >
                                 No monitoring parameters defined. Add
                                 parameters to track therapy effectiveness and
                                 safety.
                              </Typography>
                           </Paper>
                        </FixedGrid>
                              ...
                              <Card key={goal.id} variant="outlined">
                                 <CardContent sx={{ p: 2 }}>
                                    ...
                                    <Chip
                                       ...
                                       size="small"
                                       color={
                                          goal.achieved ? 'success' : 'default'
                                       }
                                       variant={
                                          goal.achieved ? 'filled' : 'outlined'
                                       }
                                    />
                                 </CardContent>
                              </Card>
                           ...
                           {goalFields.length === 0 && (
                              ...
                              >
                                 <Typography
                                    ...
                                    color="text.secondary"
                                 >
                                    No therapy goals set. Define measurable
                                    goals to track treatment success.
                                 </Typography>
                              </Paper>
                           )}
                        </Stack>
