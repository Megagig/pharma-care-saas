      ...
      <LocalizationProvider dateAdapter={AdapterDateFns}>
         <Box sx={{ p: getSpacing(1, 2, 3) }}>
               ...
               <CardContent sx={{ p: getSpacing(2, 2, 3) }}>
                  ...
                  {showNoResults && (
                     <Alert severity="info" sx={{ mt: 2 }}>
                        ...
                        different search term or create a new patient.
                     </Alert>
                  )}
               </CardContent>
            </Card>
                     ...
                     >
                        ...
                        {isMobile && (
                           <IconButton
                              size="small"
                              onClick={() =>
                                 setShowRecentPatients(!showRecentPatients)
                              }
                           >
                              {showRecentPatients ? (
                                 <ExpandLessIcon />
            ...
            >
               ...
               <form
                  onSubmit={handleNewPatientFormSubmit(handleNewPatientSubmit)}
               >
                  <DialogContent>
                     <Stack>
                        {/* Basic Information */}
                              ...
                              <Controller
                                 ...
                                 render={({ field }) => (
                                    <TextField
                                       ...
                                       helperText={
                                          newPatientErrors.firstName?.message
                                       }
                                       required
                                    />
                                 )}
                              ...
                              <Controller
                                 ...
                                 render={({ field }) => (
                                    <TextField
                                       ...
                                       helperText={
                                          newPatientErrors.lastName?.message
                                       }
                                       required
                                    />
                                 )}
                              ...
                              <Controller
                                 ...
                                 render={({ field }) => (
                                    <TextField
                                       ...
                                       helperText={
                                          newPatientErrors.email?.message
                                       }
                                    />
                                 )}
                              />
                                    ...
                                    <Autocomplete
                                       ...
                                       renderInput={(params) => (
                                          <TextField
                                             ...
                                             helperText={
                                                newPatientErrors.state?.message
                                             }
                                          />
                                       )}
                                    />
                              ...
                              <Controller
                                 ...
                                 render={({ field }) => (
                                    <TextField
                                       ...
                                       helperText={
                                          newPatientErrors.weightKg?.message
                                       }
                                       inputProps={{
                                          step: 0.1,
                                          min: 0.5,
                        ...
                        <Alert severity="info">
                           <Typography variant="body2">
                              <strong>Medical Information:</strong> Blood group
                              and genotype are important for emergency
                              situations and medication compatibility. Weight is
