                     ...
                     <Stack spacing={2}>
                        <Box>
                           ...
                           <Typography variant="h5" color="primary.main">
                              {formatCurrency(
                                 costOptimization.currentMonthlySpend
                              )}
                           </Typography>
                        </Box>
                        ...
                        <Box>
                           ...
                           <Typography variant="h6">
                              {formatCurrency(
                                 costOptimization.projectedAnnualSpend
                              )}
                           </Typography>
                        </Box>
                        ...
                        {usageMetrics.daysRemaining <= 7 && (
                           <Alert severity="warning" icon={<WarningIcon />}>
                              <Typography variant="body2">
                                 ...
                                 {usageMetrics.daysRemaining} days. Consider
                                 switching to annual billing to save money.
                              </Typography>
                           </Alert>
                        )}
                        ...
                        {getUsagePercentage(usageMetrics.storageUsed, 10) >
                           ...
                           <Alert severity="info">
                              <Typography variant="body2">
                                 ...
                                 % of your storage. Consider upgrading your plan
                              ...
                              >
                                 ...
                                 >
                                    ...
                                    <Box>
                                       ...
                                       <Typography variant="body2">
                                          Based on your usage, you might be able
                                          to save money with a lower-tier plan.
                                       </Typography>
                                    </Box>
                                 </Stack>
                              </Paper>
