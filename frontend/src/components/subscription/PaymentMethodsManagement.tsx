         ...
         <Box sx={{ mb: 3 }}>
            ...
            >
               <Typography variant="body2">
                  Stripe Card Element will be rendered here when Stripe packages
                  are installed
               </Typography>
            ...
            <Card>
               <CardContent sx={{ textAlign: 'center', py: 6 }}>
                  ...
                  <Typography
                     ...
                     sx={{ mb: 3 }}
                  >
                     Add a payment method to manage your subscription and
                     billing.
                  </Typography>
                  <Button
                     variant="contained"
         ...
         >
            ...
            <DialogContent>
               ...
               <Alert severity="warning" sx={{ mt: 2 }}>
                  This action cannot be undone. Make sure you have another
                  payment method set up for your subscription.
               </Alert>
            </DialogContent>
            <DialogActions>
