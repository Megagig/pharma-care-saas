            ...
            {success ? (
               <>
                  ...
                  <Alert severity="success" sx={{ mb: 4 }}>
                     You now have full access to all the features included in
                     your plan.
                  </Alert>
                  <Button
                     variant="contained"
               ...
               <>
                  ...
                  <Alert severity="error" sx={{ mb: 4 }}>
                     Don't worry! If your payment was processed, it may take a
                     few minutes to reflect. If you continue to have issues,
