   ...
   const shouldCheckInteraction = (drug1: string, drug2: string): boolean => {
      ...
      return interactionPairs.some(
         ([d1, d2]) =>
            ...
            (drug1.toLowerCase().includes(d2) &&
               drug2.toLowerCase().includes(d1))
      );
   };
         ...
         <Card>
            <CardContent sx={{ textAlign: 'center', py: 6 }}>
               ...
               <Typography variant="body2" color="text.secondary">
                  Please add medications in the previous step before running
                  therapy assessment
               </Typography>
            </CardContent>
         </Card>
                        ...
                        {SEVERITY_LEVELS.map((level) => (
                           ...
                           >
                              ...
                              <Chip
                                 label={
                                    problemStats[
                                       level.value as keyof typeof problemStats
                                    ]
                                 }
                                 size="small"
                                 color={
                  ...
                  <StepContent>
                                 ...
                                 {step.problems.map((problem) => (
                                    <TableRow key={problem._id}>
                                       ...
                                       <TableCell>
                                          ...
                                          >
                                             {problem.affectedMedications.map(
                                                (med) => (
                                                   <Chip
                                                      key={med}
                                                      label={med}
                     ...
                     <Box sx={{ mb: 1 }}>
                        <Button
                           ...
                           disabled={
                              step.id === 'adherence' &&
                              adherenceAssessments.some(
                                 (a) => a.adherenceScore === 0
                              )
                           }
                        >
                                 ...
                                 <TableCell align="right">
                                    <Tooltip title="Edit Problem">
                                       <IconButton
                                          size="small"
                                          onClick={() =>
                                             handleOpenProblemDialog(problem)
                                          }
                                       >
                                          <EditIcon fontSize="small" />
                                       </IconButton>
                           ...
                           render={({ field }) => (
                              <FormControl fullWidth error={!!errors.type}>
                                 ...
                                 <Select {...field} label="Problem Type">
                                    {watchedCategory &&
                                       PROBLEM_TYPES[watchedCategory]?.map(
                                          (type) => (
                                             <MenuItem
                                                key={type.value}
                                                value={type.value}
                        ...
                        <Controller
                           ...
                           render={({ field }) => (
                              <TextField
                                 ...
                                 helperText={
                                    errors.clinicalSignificance?.message
                                 }
                              />
                           )}
                        />
                     ...
                     <FixedGrid item xs={12}>
                        <Controller
                           ...
                           render={({ field }) => (
                              <FormControl
                                 fullWidth
                                 error={!!errors.affectedMedications}
                              >
