          ...
          <Card variant="outlined">
            <CardContent sx={{ textAlign: 'center', py: 2 }}>
              ...
              <Typography variant="body2" fontWeight="medium">
                {new Date(data.summary.lastReading).toLocaleDateString()}
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={6} sm={3}>
          <Card variant="outlined">
            <CardContent sx={{ textAlign: 'center', py: 2 }}>
              ...
              {data.summary.averages.bloodPressure ? (
                <Typography variant="body2" fontWeight="medium">
                  {Math.round(data.summary.averages.bloodPressure.systolic)}/
                  {Math.round(data.summary.averages.bloodPressure.diastolic)}
                </Typography>
              ) : (
                <Typography variant="body2" color="text.secondary">
                  N/A
            ...
            {data.trends.map((trend, index) => (
              <Grid item xs={12} sm={6} md={4} key={index}>
                <Box sx={{ 
                  ...
                  p: 2,
                  borderRadius: 1,
                  bgcolor: alpha(theme.palette[getTrendColor(trend.trend, trend.metric) as keyof typeof theme.palette].main, 0.1)
                }}>
