...
const InterventionsDashboard: React.FC<InterventionsDashboardProps> = ({
      ...
      if (editingIntervention) {
         setFormData({
            ...
            followUpDate: editingIntervention.followUpDate
               ? format(
                    new Date(editingIntervention.followUpDate),
                    'yyyy-MM-dd'
                 )
               : '',
         });
   ...
   const filteredInterventions = useMemo(() => {
      return interventions.filter((intervention) => {
         ...
         if (
            filterOutcome !== 'all' &&
            intervention.outcome !== filterOutcome
         ) {
            return false;
         }
            ...
            {interventionStats.total > 0 && (
               <Box sx={{ mb: 2 }}>
                  <Typography variant="body2" sx={{ mb: 1 }}>
                     ...
                     of {interventionStats.total} completed)
                  </Typography>
                  <LinearProgress
                     variant="determinate"
                     value={
                        ((interventionStats.accepted +
                           interventionStats.modified) /
                           interventionStats.total) *
                        100
                     }
         ...
         <Box sx={{ borderBottom: 1, borderColor: 'divider', mb: 2 }}>
            ...
            >
               <Tab
                  label={
                     <Badge
                        badgeContent={interventionStats.pending}
                        color="primary"
                     >
                        Timeline View
                     </Badge>
            ...
            {filteredInterventions.length === 0 ? (
               <Paper sx={{ p: 4, textAlign: 'center' }}>
                  ...
                  <Typography
                     ...
                     sx={{ mb: 2 }}
                  >
                     Start by recording your first intervention for this MTR
                     session
                  </Typography>
                  <Button
                     variant="contained"
                              ...
                              <CardContent>
                                 ...
                                 >
                                    ...
                                    <Chip
                                       size="small"
                                       icon={
                                          intervention.communicationMethod ===
                                          'phone' ? (
                                             <PhoneIcon />
                                          ) : (
                                             <EmailIcon />
                  ...
                  <Box sx={{ flex: '1 1 250px', minWidth: '250px' }}>
                     <FormControl fullWidth>
                        ...
                        >
                           ...
                           <MenuItem value="monitoring_plan">
                              Monitoring Plan
                           </MenuItem>
                  ...
                  <Box sx={{ flex: '1 1 250px', minWidth: '250px' }}>
                     <FormControl fullWidth>
                        ...
                        >
                           ...
                           <MenuItem value="healthcare_team">
                              Healthcare Team
                           </MenuItem>
                        </Select>
                     </FormControl>
