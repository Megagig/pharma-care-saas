                                 ...
                                 <Controller
                                    ...
                                    rules={{
                                       min: {
                                          value: 50,
                                          message:
                                             'Systolic BP must be at least 50',
                                       },
                                       max: {
                                          value: 300,
                                          message:
                                 ...
                                 <Controller
                                    ...
                                    rules={{
                                       min: {
                                          value: 30,
                                          message:
                                             'Diastolic BP must be at least 30',
                                       },
                                       max: {
                                          value: 200,
                                          message:
                                             'Diastolic BP cannot exceed 200',
                                       },
                                    }}
                                    render={({ field }) => (
                                       <TextField
                                 ...
                                 <Controller
                                    ...
                                    rules={{
                                       min: {
                                          value: 30,
                                          message:
                                             'Temperature must be at least 30°C',
                                       },
                                       max: {
                                          value: 45,
                                          message:
                                             'Temperature cannot exceed 45°C',
                                       },
                                    }}
                                    render={({ field }) => (
                                       <TextField
                                 ...
                                 <Controller
                                    ...
                                    rules={{
                                       min: {
                                          value: 5,
                                          message:
                                             'Respiratory rate must be at least 5',
                                       },
                                       max: {
                                          value: 60,
                                          message:
                                             'Respiratory rate cannot exceed 60',
                                       },
                                    }}
                                    render={({ field }) => (
                                       <TextField
                                 ...
                                 <Controller
                                    ...
                                    rules={{
                                       min: {
                                          value: 30,
                                          message:
                                             'FBS must be at least 30 mg/dL',
                                       },
                                       max: {
                                          value: 500,
                                          message:
                                             'FBS cannot exceed 500 mg/dL',
                                       },
                                    }}
                                    render={({ field }) => (
                                       <TextField
