                  ...
                  <Card>
                     <CardContent>
                        ...
                        {strategies.length > 0 ? (
                           ...
                           <Alert severity="info">
                              No strategies added yet. Click "Add Strategy" to
                     ...
                     <Select
                        ...
                        onChange={(e) =>
                           setStrategy((prev) => ({
                              ...prev,
                              type: e.target
                                 .value as InterventionStrategy['type'],
                           }))
                        }
                     >
                        ...
                        <MenuItem value="dose_adjustment">
                           Dose Adjustment
                        </MenuItem>
                        <MenuItem value="alternative_therapy">
                           Alternative Therapy
                        </MenuItem>
                        <MenuItem value="discontinuation">
                           Discontinuation
                        </MenuItem>
