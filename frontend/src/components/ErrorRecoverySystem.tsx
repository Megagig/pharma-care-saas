...
const NetworkStatus: React.FC<NetworkStatusProps> = ({
   ...
   return (
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
         ...
         <Typography
            variant="body2"
            color={isOnline ? 'text.primary' : 'error'}
         >
            {getConnectionText()}
         </Typography>
            ...
            <Box sx={{ mb: 2 }}>
               ...
               {visibleErrors.map((error, index) => (
                  <ErrorRecoveryCard
                     ...
                     onDismiss={
                        onDismiss ? () => onDismiss(error.type) : undefined
                     }
                     compact={isMobile}
                  />
               ))}
               ...
               <Stack spacing={2}>
                  ...
                  {hasPendingReports && (
                     <Alert severity="info">
                        ...
                        {pendingReportsCount !== 1 ? 's' : ''} waiting to be
                        sent. They will be automatically sent when connection is
                        restored.
                     </Alert>
                  )}
               </Stack>
