...
const SidebarTest: React.FC = () => {
   ...
   const tests = [
      ...
      },
      {
         ...
         test: () => {
            const pharmacySection = Array.from(
               document.querySelectorAll('*')
            ).find((el) => el.textContent?.includes('PHARMACY TOOLS'));
      ...
      <Box sx={{ p: 3, maxWidth: 1200, mx: 'auto' }}>
         ...
         <Alert severity="info" sx={{ mb: 3 }}>
            <Typography variant="body2">
               <strong>Task 6:</strong> Test sidebar functionality and
               responsive behavior
               <br />
         ...
         <Grid container spacing={3}>
                  ...
                  <CardContent>
                     ...
                     {(() => {
                        ...
                        return (
                           ...
                           >
                              <Chip
                                 label={`Total: ${stats.total}/${tests.length}`}
                              />
                              <Chip
            ...
            <Grid item xs={12} md={8}>
               <Paper sx={{ p: 2 }}>
                  ...
                  {getTestsByCategory().map(
                     ({ category, tests: categoryTests }) => (
