...
const MTRReportsDashboard: React.FC = () => {
   ...
   const renderSummaryReport = () => {
      ...
      const statusData = [
         ...
         {
            name: 'On Hold',
            value: data.summary.onHoldReviews,
            color: '#FF9800',
         },
         {
            name: 'Cancelled',
      ...
      if (interventionQuery.error) {
         return (
            <Alert severity="error" sx={{ m: 2 }}>
               ...
               {interventionQuery.error.message}
            </Alert>
         );
      }
                        ...
                        <FixedGrid item xs={12} sm={4}>
                           <Typography color="textSecondary">
                              ...
                              {(data.summary as Record<string, any>)
                                 ?.topPerformer?.pharmacistName || 'N/A'}
                           </Typography>
                        </FixedGrid>
                     </FixedGrid>
                  </CardContent>
                  ...
                  <FixedGrid item xs={12} sm={4}>
                     <Card>
                        <CardContent>
                           ...
                           <Typography variant="h4" color="primary">
                              {data.qualityMetrics.avgPlanCompletionRate.toFixed(
                                 1
                              )}
                              %
                           </Typography>
                  ...
                  <FixedGrid item xs={12} sm={4}>
                     <Card>
                        <CardContent>
                           ...
                           <Typography variant="h4" color="success.main">
                              {data.qualityMetrics.avgFollowUpCompliance.toFixed(
                                 1
                              )}
                              %
                           </Typography>
                  ...
                  <FixedGrid item xs={12} sm={4}>
                     <Card>
                        <CardContent>
                           ...
                           <Typography variant="h4" color="warning.main">
                              {data.qualityMetrics.avgProblemResolutionRate.toFixed(
                                 1
                              )}
                              %
                           </Typography>
                  ...
                  <CardContent>
                     ...
                     <FixedGrid container spacing={2}>
                        <FixedGrid item xs={12} sm={3}>
                           <Typography color="textSecondary">
                              Total Reviews:{' '}
                              {data.documentationQuality.totalReviews}
                           </Typography>
                        </FixedGrid>
                        <FixedGrid item xs={12} sm={3}>
                           <Typography color="textSecondary">
                              Complete Plans:{' '}
                              {data.documentationQuality.planCompletionRate.toFixed(
                                 1
                              )}
                              %
                           </Typography>
                  ...
                  <FixedGrid item xs={12} sm={6} md={3}>
                     <Card>
                        <CardContent>
                           ...
                           <Typography variant="h4" color="warning.main">
                              $
                              {data.summary.totalCostSavings?.toLocaleString() ||
                                 0}
                           </Typography>
                        </CardContent>
                     </Card>
