...
describe('MTRSummary', () => {
   ...
   describe('Detailed Sections', () => {
      ...
      it('displays problems section with resolution status', () => {
         ...
         expect(
            screen.getByText('Problems Identified (1)')
         ).toBeInTheDocument();
         expect(
            screen.getByText(
      ...
      it('displays therapy plan section', () => {
         ...
         expect(
            screen.getByText('Monitoring Parameters (1)')
         ).toBeInTheDocument();
      ...
      it('displays follow-up section', () => {
         ...
         expect(
            screen.getByText('Follow-Up Activities (1)')
         ).toBeInTheDocument();
         expect(
   ...
   describe('Expandable Sections', () => {
      ...
      it('expands and collapses problem details', () => {
         ...
         expect(
            screen.getByText('Increased bleeding risk')
         ).toBeInTheDocument();
      });
   ...
   describe('Empty States', () => {
      it('displays empty state when no review is available', () => {
         ...
         expect(
            screen.getByText('No MTR session available')
         ).toBeInTheDocument();
         expect(
            screen.getByText(
      ...
      it('displays empty state for medications when none exist', () => {
         ...
         expect(
            screen.getByText('No medications documented')
         ).toBeInTheDocument();
      });
      ...
      it('displays empty state for problems when none identified', () => {
         ...
         expect(
            screen.getByText('Problems Identified (0)')
         ).toBeInTheDocument();
      ...
      it('displays empty state for interventions when none made', () => {
         ...
         expect(
            screen.getByText('No interventions recorded')
         ).toBeInTheDocument();
      });
   });
