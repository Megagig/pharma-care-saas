   ...
   return (
      <Box>
         ...
         <Typography variant="body2" color="text.secondary" paragraph>
            As a {user?.role?.replace('_', ' ')}, you need to verify your
            pharmacist license to access all features.
         </Typography>
                     ...
                     <StepContent>
                        <Box sx={{ mb: 2 }}>
                           <Alert severity="info" sx={{ mb: 2 }}>
                              Upload a clear photo or PDF of your pharmacist
                  ...
                  <Step>
                     ...
                     <StepContent>
                        <Alert severity="warning" sx={{ mb: 2 }}>
                           Your license is currently being reviewed by our team.
                  ...
                  <Step>
                     ...
                     <StepContent>
                        <Alert severity="success">
                           ...
                           <Typography variant="body2">
                              Your pharmacist license has been approved. You now
