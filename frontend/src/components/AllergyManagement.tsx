                     ...
                     >
                        ...
                        <Box sx={{ minWidth: 150 }}>
                           <Typography variant="body2" color="text.secondary">
                              {filteredAllergies.length} of {allergies.length}{' '}
                              shown
                           </Typography>
                        </Box>
                     </Box>
                     ...
                     <Stack spacing={3}>
                        ...
                        <Controller
                           ...
                           rules={{
                              ...
                              minLength: {
                                 value: 2,
                                 message:
                                    'Substance name must be at least 2 characters',
                              },
                              maxLength: {
                                 value: 100,
                                 message:
                                    'Substance name cannot exceed 100 characters',
                              },
                           }}
                           render={({ field }) => (
                              <TextField
                           ...
                           >
                              {COMMON_ALLERGENS.slice(0, 12).map((allergen) => (
                                 <Chip
                                    ...
                                    size="small"
                                    onClick={() =>
                                       handleCommonAllergenSelect(allergen)
                                    }
                                    sx={{ cursor: 'pointer' }}
                                    variant={
                        ...
                        {watch('severity') === 'severe' && (
                           <Alert severity="warning" sx={{ mt: 2 }}>
                              <Typography variant="body2">
                                 <strong>Severe Allergy Warning:</strong> This
                                 allergy will be prominently displayed in the
                                 patient's profile and flagged during medication
