               ...
               >
                  <Alert severity="error" sx={{ mb: 3 }}>
                     ...
                     <Typography variant="body2" sx={{ mt: 1 }}>
                        An error occurred while loading the clinical notes
                        module.
                  ...
                  <Stack direction="row" spacing={2} sx={{ mb: 3 }}>
                     {canRetry && (
                        ...
                        >
                           Try Again ({this.maxRetries - this.retryCount}{' '}
                           attempts left)
                        </Button>
                     )}
                  ...
                  >
                     ...
                     <DialogContent>
                        ...
                        >
                           ...
                           when this error occurred. This information will be
                           sent to our development team.
                        </Typography>
                        ...
                        <Alert severity="info" sx={{ mb: 2 }}>
                           <Typography variant="body2">
                              <strong>Error ID:</strong> {this.state.errorId}
                              <br />
                              This ID will be included in your report for
                              tracking purposes.
                           </Typography>
                        </Alert>
                     </DialogContent>
