...
const MedicationHistory: React.FC<MedicationHistoryProps> = ({
   ...
   const [swipedMedication, setSwipedMedication] = useState<string | null>(
      null
   );
   ...
   useEffect(() => {
      const checkDuplicates = () => {
         ...
         medications.forEach((med, index) => {
            ...
            const currentClass =
               therapeuticClasses[
                  normalizedName as keyof typeof therapeuticClasses
               ];
            if (currentClass) {
   ...
   const handleImportMedications = async () => {
      try {
         ...
         const existingMeds =
            await medicationService.getMedicationsByPatient(patientId);
         ...
         <Box sx={{ p: getSpacing(1, 2, 3) }}>
            ...
            <Box sx={{ mb: getSpacing(2, 3, 4) }}>
               ...
               <Typography variant="body2" color="text.secondary">
                  Document all medications including prescribed,
                     ...
                     {memoizedCategories.map((category, index) => (
                        <Tab
                           ...
                           label={
                              <Badge
                                 badgeContent={
                                    getMedicationsByCategory(category.value)
                                       .length
                                 }
                                 color={
                                    category.color as
                     ...
                     {getMedicationsByCategory(category.value).length === 0 ? (
                        ...
                        >
                           ...
                           <Typography
                              ...
                              sx={{ mb: 2 }}
                           >
                              Click "Add {category.label.split('/')[0]}" to
                              document medications in this category
                           </Typography>
                           <Button
                              variant="contained"
                              startIcon={<AddIcon />}
                              onClick={() =>
                                 handleAddMedication(category.value)
                              }
                           >
                              Add {category.label.split('/')[0]}
                           </Button>
                           ...
                           <FixedGrid item xs={12}>
                              ...
                              >
                                 <Chip
                                    ...
                                    color={
                                       isManualEntry ? 'secondary' : 'primary'
                                    }
                                    size="small"
                                    icon={
                                       isManualEntry ? (
                                       ...
                                       {isManualEntry &&
                                          !medicationErrors.dosageForm && (
                                             <FormHelperText>
                                                ...
                                                select the physical form of the
                                                medication
                                             </FormHelperText>
                                          )}
                                    </FormControl>
                              ...
                              <Controller
                                 ...
                                 render={({ field }) => (
                                    <TextField
                                       ...
                                       error={
                                          !!medicationErrors.instructions?.dose
                                       }
                                       helperText={
                                          medicationErrors.instructions?.dose
                                             ?.message
                              ...
                              <Controller
                                 ...
                                 render={({ field }) => (
                                    <TextField
                                       ...
                                       helperText={
                                          medicationErrors.indication?.message
                                       }
                                       required
                                    />
                                 )}
