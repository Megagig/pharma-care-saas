            ...
            {unsavedChanges && !readonly && (
               <Alert severity="warning" sx={{ mb: 2 }}>
                  <Box display="flex" alignItems="center" gap={1}>
                     ...
                     You have unsaved changes. They will be lost if you navigate
                     away.
                  </Box>
               </Alert>
            )}
               ...
               <Grid item xs={12}>
                  <Card>
                     <CardContent>
                        ...
                        <Collapse
                           in={sections.find((s) => s.id === 'basic')?.expanded}
                        >
               ...
               <Grid item xs={12}>
                  <Card>
                     <CardContent>
                        ...
                        <Collapse
                           in={sections.find((s) => s.id === 'soap')?.expanded}
                        >
                           {errors.content && (
