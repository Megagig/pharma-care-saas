...
const TeamCollaborationStep: React.FC<TeamCollaborationStepProps> = ({
   ...
   const renderTeamOverview = () => {
      const roleCount = watchedAssignments.reduce(
         (acc, assignment) => {
               ...
               <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} md={6}>
                     <Controller
                        ...
                        control={control}
                        rules={{
                           required: 'Team member selection is required',
                        }}
                        render={({ field }) => (
                           <Autocomplete
                              {...field}
                              ...
                              renderInput={(params) => (
                                 <TextField
                                    ...
                                    error={
                                       !!errors.assignments?.[index]?.userId
                                    }
                                    helperText={
                                       errors.assignments?.[index]?.userId
                                          ?.message
                     ...
                     <Controller
                        ...
                        render={({ field }) => (
                           <TextField
                              ...
                              helperText={
                                 errors.assignments?.[index]?.task?.message
                              }
                           />
                        )}
                     />
      ...
      <Card sx={{ mb: 3 }}>
         <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
               Assign specific tasks to team members for collaborative
            ...
            {fields.length === 0 ? (
               ...
               <Box>
                  {fields.map((field, index) => renderAssignmentForm(index))}
               </Box>
            )}
         </CardContent>
      </Card>
            ...
            {selectedTemplate && (
               <Box>
                  ...
                  <Alert severity="info" sx={{ mt: 2 }}>
                     ...
                     intervention details. Placeholders like [Patient Name] and
                     [Issue Description] should be replaced with actual values.
                  </Alert>
               </Box>
            )}
         </DialogContent>
            ...
            <Timeline>
               <TimelineItem>
                  ...
                  <TimelineContent>
                     ...
                     <Typography>
                        Initial team assignments configured
                     </Typography>
                  </TimelineContent>
               </TimelineItem>
               <TimelineItem>
   ...
   return (
      <Box>
         ...
         <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            Assign tasks to healthcare team members for collaborative
            intervention implementation
         </Typography>
