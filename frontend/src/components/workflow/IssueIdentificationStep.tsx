   ...
   const renderPrioritySelection = () => (
      <Card sx={{ mb: 3 }}>
         <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
               Select the urgency level based on clinical impact and patient
               safety
            </Typography>
      ...
      return (
         ...
         >
            ...
            <Typography variant="body2" sx={{ mb: 1 }}>
               {duplicateInterventions.length} existing intervention(s) with the
               same category. Please review to avoid duplicates.
            </Typography>
            <Box sx={{ mt: 1 }}>
