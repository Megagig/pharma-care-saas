...
const OutcomeTrackingStep: React.FC<OutcomeTrackingStepProps> = ({
   ...
   const defaultValues: OutcomeTrackingData = useMemo(
      () => ({
         outcome: {
            ...
            successMetrics: {
               problemResolved:
                  initialData?.outcome?.successMetrics?.problemResolved ||
                  false,
               medicationOptimized:
                  initialData?.outcome?.successMetrics?.medicationOptimized ||
                  false,
               adherenceImproved:
                  initialData?.outcome?.successMetrics?.adherenceImproved ||
                  false,
               costSavings:
                  initialData?.outcome?.successMetrics?.costSavings ||
                  undefined,
   ...
   const renderClinicalParameters = () => (
      <Accordion
         ...
         onChange={() =>
            setExpandedSection(
               expandedSection === 'parameters' ? '' : 'parameters'
            )
         }
      >
         <AccordionSummary expandIcon={<ExpandMoreIcon />}>
         ...
         <AccordionDetails>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
               Track measurable clinical parameters before and after
               intervention
            </Typography>
                        ...
                        <Grid container spacing={2}>
                           ...
                           <Grid item xs={12} md={3}>
                              <Controller
                                 ...
                                 control={control}
                                 rules={{
                                    required: 'Before value is required',
                                 }}
                                 render={({ field }) => (
                                    <TextField
                                       {...field}
                                       ...
                                       error={
                                          !!errors.outcome
                                             ?.clinicalParameters?.[index]
                                             ?.beforeValue
                                       }
                                       helperText={
                                          errors.outcome?.clinicalParameters?.[
                                             index
                                          ]?.beforeValue?.message
                                       }
                                    />
   ...
   const renderSuccessMetrics = () => (
      ...
      >
         ...
         <AccordionDetails>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
               Evaluate the success of the intervention across different
               dimensions
            </Typography>
