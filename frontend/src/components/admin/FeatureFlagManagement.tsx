               ...
               resolve({
                  ...
                  data: [
                     ...
                     },
                     {
                        ...
                        key: 'api_access',
                        description:
                           'Access to API endpoints for external integration',
                        isActive: false,
   ...
   const handleRemoveTag = (tagToRemove: string) => {
      setFormData((prev) => ({
         ...
         metadata: {
            ...prev.metadata!,
            tags:
               prev.metadata?.tags?.filter((tag) => tag !== tagToRemove) || [],
         },
      }));
   };
   ...
   const handleSubmit = async () => {
      try {
         ...
         if (isEditing && selectedFeature) {
            ...
            response =
               await localFeatureFlagService.createFeatureFlag(createFlagData);
                           ...
                           <TableRow key={feature._id}>
                              ...
                              <TableCell>
                                 ...
                                 <Tooltip title="Delete">
                                    <IconButton
                                       onClick={() =>
                                          handleDeleteDialogOpen(feature)
                                       }
                                       color="error"
                                    >
                                       <DeleteIcon />
         ...
         >
            ...
            <DialogContent>
               <GridContainer spacing={3} sx={{ mt: 0 }}>
                  ...
                  <GridItem xs={12} md={6}>
                     <FormControl fullWidth>
                        <InputLabel id="allowed-roles-label">
                           Allowed Roles
                        </InputLabel>
                        <Select
                     ...
                     <FormControlLabel
                        control={
                           <Switch
                              ...
                              checked={
                                 formData.customRules?.requiredLicense || false
                              }
                              onChange={handleSwitchChange}
                              color="primary"
                           />
         ...
         >
            ...
            <DialogContent>
               ...
               <Alert severity="warning" sx={{ mt: 2 }}>
                  This action cannot be undone. Any code depending on this
                  feature flag may break.
               </Alert>
            </DialogContent>
            <DialogActions>
