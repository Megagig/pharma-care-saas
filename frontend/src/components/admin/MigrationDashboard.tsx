...
const MigrationDashboard: React.FC = () => {
   ...
   const [migrations, setMigrations] = useState<Migration[]>([
      ...
      },
      {
         ...
         createdBy: 'admin@example.com',
         description:
            'Modified medication schema to include dosage instructions',
         version: '1.1.5',
      },
      {
         id: '3',
         ...
         >
            ...
            <DialogActions>
               ...
               <Button
                  ...
                  startIcon={
                     loading ? <CircularProgress size={20} /> : <RunIcon />
                  }
               >
                  Run Migration
               </Button>
               ...
               <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <Box sx={{ ml: 1 }}>
                     ...
                     <Chip
                        ...
                        color={
                           getStatusColor(
                              selectedMigration?.status || 'default'
                           ) as any
                        }
                        sx={{ ml: 1 }}
                     />
                        ...
                        <Grid item xs={12} md={6}>
                           ...
                           {selectedMigration.duration && (
                              <Typography variant="body2" sx={{ mb: 1 }}>
                                 ...
                                 {selectedMigration.duration} seconds
                              </Typography>
                           )}
                        </Grid>
                        <Grid item xs={12}>
