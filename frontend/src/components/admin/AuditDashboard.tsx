                  ...
                  <Card>
                     <CardContent>
                        ...
                        <Typography
                           variant="h5"
                           color={
                              summaryData.errorRate > 5 ? 'error' : 'success'
                           }
                        >
                  ...
                  <Card>
                     <CardContent>
                        ...
                        <Typography
                           variant="h5"
                           color={
                              summaryData.complianceScore > 80
                                 ? 'success'
                                 : 'warning'
                           }
                        >
                     ...
                     <Grid item xs={12} sm={6} md={3}>
                        <FormControl fullWidth>
                           ...
                           >
                              ...
                              {filterOptions?.resourceTypes?.map(
                                 (type: string) => (
