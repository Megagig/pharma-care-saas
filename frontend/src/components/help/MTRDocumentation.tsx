   ...
   return (
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
         ...
         <Typography variant="body1" paragraph>
            Comprehensive guide to using the Medication Therapy Review (MTR)
            module effectively. This documentation covers the complete workflow,
                     ...
                     <Card>
                        <CardContent>
                           ...
                           <Typography variant="body2" paragraph>
                              Medication Therapy Review is a systematic process
                              where pharmacists evaluate a patient's complete
                              medication regimen to identify drug-related
                              problems and optimize therapy outcomes.
                           </Typography>
                           <Typography variant="body2">
                              The MTR process follows a structured 6-step
                              workflow to ensure comprehensive assessment and
         ...
         >
            ...
            <AccordionDetails>
               <Alert severity="info" sx={{ mb: 3 }}>
                  <Typography variant="body2">
                     <strong>Total Time Estimate:</strong> 60-90 minutes for a
            ...
            <AccordionDetails>
               ...
               <Alert severity="info" sx={{ mt: 3 }}>
                  <Typography variant="body2">
                     ...
                     <br />• Access additional training materials or request
                     refresher sessions
                  </Typography>
               </Alert>
            </AccordionDetails>
