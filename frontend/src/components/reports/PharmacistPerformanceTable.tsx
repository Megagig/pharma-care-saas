         ...
         <CardContent>
            ...
            >
               <Typography variant="h6">
                  Pharmacist Performance Rankings
               </Typography>
            ...
            {data.summary.topPerformer && (
               ...
               >
                  ...
                  <Chip
                     label={`Quality Score: ${
                        data.summary.topPerformer.qualityScore?.toFixed(1) ||
                        'N/A'
                     }`}
                     color="warning"
                     size="small"
                     ...
                     <TableRow>
                        ...
                        <TableCell>
                           <TableSortLabel
                              ...
                              onClick={() =>
                                 handleSort('interventionAcceptanceRate')
                              }
                           >
                              Intervention Rate
                           </TableSortLabel>
                     ...
                     {sortedData.map((pharmacist, index) => (
                        ...
                        >
                           ...
                           <TableCell>
                              <Box>
                                 <Typography variant="body2">
                                    {pharmacist.interventionAcceptanceRate.toFixed(
                                       1
                                    )}
                                    %
                                 </Typography>
                           ...
                           <TableCell>
                              <Tooltip
                                 title={`Avg completion time: ${
                                    pharmacist.avgCompletionTime?.toFixed(1) ||
                                    0
                                 } days`}
                              >
                                 <Chip
                           ...
                           <TableCell>
                              <Box>
                                 ...
                                 >
                                    Rate:{' '}
                                    {pharmacist.problemResolutionRate.toFixed(
                                       1
                                    )}
                                    %
                                 </Typography>
                           ...
                           <TableCell>
                              <Typography variant="body2" color="primary.main">
                                 $
                                 {pharmacist.totalCostSavings?.toLocaleString() ||
                                    0}
                              </Typography>
                           </TableCell>
                        </TableRow>
