                     ...
                     {followUp.status === 'scheduled' && (
                        <>
                           <Tooltip title="Complete Follow-up">
                              <IconButton
                                 onClick={() =>
                                    handleOpenOutcomeDialog(followUp)
                                 }
                                 color="success"
                                 size="small"
                              >
                           ...
                           <Tooltip title="Reschedule">
                              <IconButton
                                 onClick={() =>
                                    handleOpenRescheduleDialog(followUp)
                                 }
                                 color="warning"
                                 size="small"
                              >
                        ...
                        {followUp.outcome.nextActions &&
                           followUp.outcome.nextActions.length > 0 && (
                              <Box>
                                 ...
                                 <List dense>
                                    {followUp.outcome.nextActions.map(
                                       (action, index) => (
                                          <ListItem key={index} sx={{ py: 0 }}>
                                             <ListItemText
                                                primary={action}
      ...
      <LocalizationProvider dateAdapter={AdapterDateFns}>
         <Box>
            ...
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
               ...
               >
                  <Tab
                     label={
                        <Badge
                           badgeContent={overdueFollowUps.length}
                           color="error"
                        >
                           Overdue
                        </Badge>
                  ...
                  <Tab
                     label={
                        <Badge
                           badgeContent={upcomingFollowUps.length}
                           color="primary"
                        >
                           Upcoming
                        </Badge>
                  ...
                  >
                     <Box sx={{ flex: '1 1 300px', minWidth: '300px' }}>
                        <FormControl fullWidth>
                           ...
                           >
                              ...
                              <MenuItem value="adherence_check">
                                 Adherence Check
                              </MenuItem>
                     ...
                     <Box sx={{ flex: '1 1 300px', minWidth: '300px' }}>
                        <DateTimePicker
                           ...
                           onChange={(date) =>
                              handleFormChange('scheduledDate', date)
                           }
                           slotProps={{
                              textField: {
                                 fullWidth: true,
            ...
            >
               ...
               <DialogActions>
                  <Button onClick={() => setOutcomeDialogOpen(false)}>
                     Cancel
                  </Button>
                  <Button
