   ...
   return (
      <Paper elevation={2} className="p-4">
         <Box
            ...
            className="mb-4"
         >
            <Typography variant="h6">Therapy Plans</Typography>
            <Button
               variant="contained"
               startIcon={<AddIcon />}
               onClick={handleOpen}
         ...
         {savedPlans.length === 0 ? (
            <Alert severity="info">
               No therapy plans created yet. Create your first plan to save drug
               information.
            </Alert>
         ) : (
            <List>
                  ...
                  <ListItem key={plan._id} className="border-b last:border-b-0">
                     ...
                     <ListItemSecondaryAction>
                        <IconButton
                           ...
                           aria-label="delete"
                           onClick={() =>
                              plan._id && handleDeletePlan(plan._id)
                           }
                        >
                           <DeleteIcon />
                        </IconButton>
