               ...
               <Box>
                  ...
                  >
                     <Chip
                        ...
                        sx={{
                           bgcolor:
                              INTERVENTION_CATEGORIES[intervention.category]
                                 ?.color + '20',
                           color: INTERVENTION_CATEGORIES[intervention.category]
                              ?.color,
                           fontWeight: 'medium',
                        }}
                     />
                     <Chip
                        ...
                        sx={{
                           bgcolor:
                              PRIORITY_LEVELS[intervention.priority]?.color +
                              '20',
                     ...
                     <Chip
                        ...
                        sx={{
                           bgcolor:
                              STATUS_LABELS[intervention.status]?.color + '20',
                  ...
                  <Typography variant="body2" color="text.secondary">
                     Created on{' '}
                     {new Date(intervention.createdAt).toLocaleDateString()} by{' '}
               ...
               <Box sx={{ mt: 2, display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                  ...
                  {intervention.estimatedDuration && (
                     ...
                     >
                        ...
                        <Typography variant="body2" color="text.secondary">
                           Est. Duration: {intervention.estimatedDuration}{' '}
                           minutes
                        </Typography>
                     </Box>
                  )}
            ...
            <CardContent>
               ...
               <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                     ...
                     <Stack spacing={1}>
                        {Object.entries(outcomes.successMetrics).map(
                           ([key, value]) => (
                              <Box
                                 key={key}
                                 sx={{
                     ...
                     {outcomes.clinicalParameters &&
                        outcomes.clinicalParameters.length > 0 && (
                           <>
                              ...
                              <Stack spacing={1}>
                                 {outcomes.clinicalParameters.map(
                                    (param, index) => (
                                       <Paper
                                          key={index}
