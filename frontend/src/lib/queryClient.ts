...
export const queryKeys = {
   ...
   medications: {
      ...
      current: (patientId: string) =>
         ['medications', 'patient', patientId, 'current'] as const,
      past: (patientId: string) =>
         ['medications', 'patient', patientId, 'past'] as const,
   },
   ...
   assessments: {
      ...
      latest: (patientId: string) =>
         ['assessments', 'patient', patientId, 'latest'] as const,
   },
   ...
   dtps: {
      ...
      active: (patientId: string) =>
         ['dtps', 'patient', patientId, 'active'] as const,
   },
   ...
   carePlans: {
      ...
      latest: (patientId: string) =>
         ['carePlans', 'patient', patientId, 'latest'] as const,
   },
   ...
   visits: {
      ...
      attachments: (visitId: string) =>
         ['visits', 'detail', visitId, 'attachments'] as const,
   },
   ...
   drugTherapyProblems: {
      ...
      byReview: (reviewId: string) =>
         ['drugTherapyProblems', 'review', reviewId] as const,
   ...
   mtrInterventions: {
      ...
      byReview: (reviewId: string) =>
         ['mtrInterventions', 'review', reviewId] as const,
   ...
   mtrFollowUps: {
      ...
      byReview: (reviewId: string) =>
         ['mtrFollowUps', 'review', reviewId] as const,
   ...
   clinicalInterventions: {
      ...
      search: (query: string) =>
         ['clinicalInterventions', 'search', query] as const,
      analytics: {
         ...
         categories: () =>
            ['clinicalInterventions', 'analytics', 'categories'] as const,
         priorities: () =>
            ['clinicalInterventions', 'analytics', 'priorities'] as const,
      },
