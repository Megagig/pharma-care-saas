...
# Or using Docker
docker build -t pharmacare-app:manual-lab .
docker push your-registry/pharmacare-app:manual-lab
docker service update --image your-registry/pharmacare-app:manual-lab pharmacare-app
```
...
docker service update --image your-registry/pharmacare-app:previous-version pharmacare-app
...
```bash
# Stop application
docker service scale pharmacare-app=0
...
docker service update --image your-registry/pharmacare-app:previous-version pharmacare-app
docker service scale pharmacare-app=3
```
...
kubectl top pods -l app=pharmacare-app
