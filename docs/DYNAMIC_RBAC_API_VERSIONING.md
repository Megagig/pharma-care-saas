...
```javascript
// V1 Client Code
const client = new PharmaPilotClient({
...
class ClientMigrationHelper {
  constructor(baseURL, apiKey) {
    this.v1Client = new PharmaPilotClient({ baseURL: `${baseURL}/v1`, apiKey });
    this.v2Client = new PharmaPilotClient({ baseURL: `${baseURL}/v2`, apiKey });
