...
This document provides comprehensive API documentation for the workspace-level subscription management, invitation system, usage enforcement, and enhanced RBAC features in the Pharmacare SaaS application.

## Base URL

```
Production: https://api.pharmacare.com
...
```bash
curl -X GET \
  "https://api.pharmacare.com/api/workspaces/64a1b2c3d4e5f6789012345/invitations" \
...
```bash
curl -X GET \
  "https://api.pharmacare.com/api/user/permissions" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
- **Billing Issues:** billing@pharmacare.com
- **API Documentation:** developers@pharmacare.com
